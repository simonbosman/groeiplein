...
insert into groepdoel(id, doel_id, groupuuid) values (1, 1, '3fa85f64-5717-4562-b3fc-2c963f66afa6');
insert into groepopdracht(id, opdracht_id, groepuuid) values (1, 1, '3fa85f64-5717-4562-b3fc-2c963f66afa6');
insert into scorevalue(id, value, kleur, title) values (1, 1, 'testkleur', 'testtitle');
insert into score(id, doel_id, feedback_id, leerling_id, timestamp, updatetimestamp, value_id, authoruuid, author) values (1, 1, 1, 1, '2022-03-10T16:15:50Z','2022-03-10T16:15:50Z',  '3fa85f64-5717-4562-b3fc-2c963f66afa6', 'DOCENT');
