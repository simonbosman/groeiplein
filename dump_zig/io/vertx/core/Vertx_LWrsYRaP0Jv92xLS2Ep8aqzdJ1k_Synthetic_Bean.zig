// Class: io/vertx/core/Vertx_LWrsYRaP0Jv92xLS2Ep8aqzdJ1k_Synthetic_Bean
...
(
    ...
    ** label1
    ...
    PUTFIELD io/vertx/core/Vertx_LWrsYRaP0Jv92xLS2Ep8aqzdJ1k_Synthetic_Bean#types
    ...
    PUTFIELD io/vertx/core/Vertx_LWrsYRaP0Jv92xLS2Ep8aqzdJ1k_Synthetic_Bean#params
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/Map;
    GETFIELD io/vertx/core/Vertx_LWrsYRaP0Jv92xLS2Ep8aqzdJ1k_Synthetic_Bean#params
    ASTORE 2
    ...
    ** label2
    ...
    INVOKEVIRTUAL io/vertx/core/Vertx_LWrsYRaP0Jv92xLS2Ep8aqzdJ1k_Synthetic_Bean#createSynthetic
    ASTORE 9
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label2
    ...
    INVOKESPECIAL io/vertx/core/Vertx_LWrsYRaP0Jv92xLS2Ep8aqzdJ1k_Synthetic_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/vertx/core/Vertx;
    INVOKEVIRTUAL io/vertx/core/Vertx_LWrsYRaP0Jv92xLS2Ep8aqzdJ1k_Synthetic_Bean#create
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/vertx/core/Vertx;
    INVOKEVIRTUAL io/vertx/core/Vertx_LWrsYRaP0Jv92xLS2Ep8aqzdJ1k_Synthetic_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/vertx/core/Vertx_LWrsYRaP0Jv92xLS2Ep8aqzdJ1k_Synthetic_Bean#types
    ARETURN
    ** label2
