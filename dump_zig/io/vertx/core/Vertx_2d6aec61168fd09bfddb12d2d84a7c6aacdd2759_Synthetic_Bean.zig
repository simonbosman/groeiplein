// Class: io/vertx/core/Vertx_2d6aec61168fd09bfddb12d2d84a7c6aacdd2759_Synthetic_Bean
...
(
    ...
    ** label1
    ...
    ASTORE 2
    LDC (String) "io.vertx.core.Vertx"
    ICONST_0
    ALOAD 1
    ...
    PUTFIELD io/vertx/core/Vertx_2d6aec61168fd09bfddb12d2d84a7c6aacdd2759_Synthetic_Bean#types
    ...
    PUTFIELD io/vertx/core/Vertx_2d6aec61168fd09bfddb12d2d84a7c6aacdd2759_Synthetic_Bean#params
    RETURN
    ** label2
...
// Access: private
Method doCreate : Lio/vertx/core/Vertx;
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/Map;
    GETFIELD io/vertx/core/Vertx_2d6aec61168fd09bfddb12d2d84a7c6aacdd2759_Synthetic_Bean#params
    ASTORE 2
    ...
    ** label2
    ...
    // Method descriptor: (Lio/quarkus/arc/SyntheticCreationalContext;)Lio/vertx/core/Vertx;
    INVOKEVIRTUAL io/vertx/core/Vertx_2d6aec61168fd09bfddb12d2d84a7c6aacdd2759_Synthetic_Bean#createSynthetic
    ASTORE 9
    ** label3
    GOTO label4
    ** label5
...
// Access: private
Method createSynthetic : Lio/vertx/core/Vertx;
(
    ...
    ** label2
    NEW jakarta/enterprise/inject/CreationException
    DUP
    LDC (String) "Synthetic bean instance for io.vertx.core.Vertx not initialized yet: io_vertx_core_Vertx_74affa450965de1cd6a7217ce7ce0dbad2c16185
...
// Access: public
Method create : Lio/vertx/core/Vertx;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/vertx/core/Vertx;
    INVOKESPECIAL io/vertx/core/Vertx_2d6aec61168fd09bfddb12d2d84a7c6aacdd2759_Synthetic_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/vertx/core/Vertx;
    INVOKEVIRTUAL io/vertx/core/Vertx_2d6aec61168fd09bfddb12d2d84a7c6aacdd2759_Synthetic_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Lio/vertx/core/Vertx;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/vertx/core/Vertx;
    INVOKEVIRTUAL io/vertx/core/Vertx_2d6aec61168fd09bfddb12d2d84a7c6aacdd2759_Synthetic_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/vertx/core/Vertx_2d6aec61168fd09bfddb12d2d84a7c6aacdd2759_Synthetic_Bean#types
    ARETURN
    ** label2
