// Class: io/vertx/pgclient/PgPool_7weXgYHcaRck_k2l7dGKfXZMdD8_Synthetic_ClientProxy
...
(
    ...
    ** label1
    ...
    PUTFIELD io/vertx/pgclient/PgPool_7weXgYHcaRck_k2l7dGKfXZMdD8_Synthetic_ClientProxy#bean
    ALOAD 2
    ...
    PUTFIELD io/vertx/pgclient/PgPool_7weXgYHcaRck_k2l7dGKfXZMdD8_Synthetic_ClientProxy#context
    RETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableBean;
    GETFIELD io/vertx/pgclient/PgPool_7weXgYHcaRck_k2l7dGKfXZMdD8_Synthetic_ClientProxy#bean
    ASTORE 1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD io/vertx/pgclient/PgPool_7weXgYHcaRck_k2l7dGKfXZMdD8_Synthetic_ClientProxy#context
    ALOAD 1
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/vertx/pgclient/PgPool_7weXgYHcaRck_k2l7dGKfXZMdD8_Synthetic_ClientProxy#arc$delegate
    ARETURN
    ** label2
