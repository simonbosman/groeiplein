// Class: io/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_Bean
...
Field proxy : Lio/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_ClientProxy;

// Access: private final
Field params : Ljava/util/Map;

// Access: private
Method proxy : Lio/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_ClientProxy;
(
    // (no arguments)
) {
    ** label1
    ALOAD 0
    // Field descriptor: Lio/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_ClientProxy;
    GETFIELD io/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_Bean#proxy
    ASTORE 1
    ALOAD 1
    IFNULL label2
    ** label3
    ** label4
    GOTO label5
    ** label2
    NEW io/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_ClientProxy
    DUP
    LDC (String) "ef07978181dc691724fe4da5edd18a7d764c743f"
    // Method descriptor: (Ljava/lang/String;)V
    INVOKESPECIAL io/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_ClientProxy#<init>
    ASTORE 1
    ALOAD 0
    ALOAD 1
    // Field descriptor: Lio/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_ClientProxy;
    PUTFIELD io/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_Bean#proxy
    ** label5
    ALOAD 1
    ARETURN
    ** label6
...
(
    ...
    ** label1
    ...
    PUTFIELD io/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_Bean#types
    ...
    PUTFIELD io/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_Bean#params
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/Map;
    GETFIELD io/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_Bean#params
    ASTORE 2
    ...
    ** label2
    ...
    INVOKEVIRTUAL io/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_Bean#createSynthetic
    ASTORE 9
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label2
    ...
    INVOKESPECIAL io/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/vertx/pgclient/PgPool;
    INVOKEVIRTUAL io/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_Bean#create
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Method descriptor: ()Lio/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_ClientProxy;
    INVOKEVIRTUAL io/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_Bean#proxy
    CHECKCAST io/vertx/pgclient/PgPool
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/vertx/pgclient/PgPool;
    INVOKEVIRTUAL io/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/vertx/pgclient/PgPool_ef07978181dc691724fe4da5edd18a7d764c743f_Synthetic_Bean#types
    ARETURN
    ** label2
