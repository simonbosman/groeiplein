// Class: io/smallrye/jwt/KeyProvider_5b44e959c7e35394605c51c6f64847e6dfe7ae65_Synthetic_Bean
...
(
    ...
    ** label1
    ...
    PUTFIELD io/smallrye/jwt/KeyProvider_5b44e959c7e35394605c51c6f64847e6dfe7ae65_Synthetic_Bean#types
    ICONST_2
    ANEWARRAY java/lang/Object
    ASTORE 6
    ...
    ALOAD 9
    // Field descriptor: Ljava/util/Set;
    PUTFIELD io/smallrye/jwt/KeyProvider_5b44e959c7e35394605c51c6f64847e6dfe7ae65_Synthetic_Bean#qualifiers
    ...
    PUTFIELD io/smallrye/jwt/KeyProvider_5b44e959c7e35394605c51c6f64847e6dfe7ae65_Synthetic_Bean#params
    RETURN
    ** label2
...
// Access: private
Method doCreate : Lio/smallrye/jwt/KeyProvider;
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/Map;
    GETFIELD io/smallrye/jwt/KeyProvider_5b44e959c7e35394605c51c6f64847e6dfe7ae65_Synthetic_Bean#params
    ASTORE 2
    ...
    ** label2
    ...
    // Method descriptor: (Lio/quarkus/arc/SyntheticCreationalContext;)Lio/smallrye/jwt/KeyProvider;
    INVOKEVIRTUAL io/smallrye/jwt/KeyProvider_5b44e959c7e35394605c51c6f64847e6dfe7ae65_Synthetic_Bean#createSynthetic
    ASTORE 9
    ** label3
    GOTO label4
    ** label5
...
// Access: private
Method createSynthetic : Lio/smallrye/jwt/KeyProvider;
(
...
// Access: public
Method create : Lio/smallrye/jwt/KeyProvider;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/smallrye/jwt/KeyProvider;
    INVOKESPECIAL io/smallrye/jwt/KeyProvider_5b44e959c7e35394605c51c6f64847e6dfe7ae65_Synthetic_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/smallrye/jwt/KeyProvider;
    INVOKEVIRTUAL io/smallrye/jwt/KeyProvider_5b44e959c7e35394605c51c6f64847e6dfe7ae65_Synthetic_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Lio/smallrye/jwt/KeyProvider;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/smallrye/jwt/KeyProvider;
    INVOKEVIRTUAL io/smallrye/jwt/KeyProvider_5b44e959c7e35394605c51c6f64847e6dfe7ae65_Synthetic_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/smallrye/jwt/KeyProvider_5b44e959c7e35394605c51c6f64847e6dfe7ae65_Synthetic_Bean#types
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/smallrye/jwt/KeyProvider_5b44e959c7e35394605c51c6f64847e6dfe7ae65_Synthetic_Bean#qualifiers
    ARETURN
    ** label2
...
(
    ...
    ** label1
    LDC (Type) Lio/smallrye/jwt/KeyProvider;
    ARETURN
    ** label2
