// Class: io/smallrye/jwt/auth/cdi/ClaimValueProducer_ProducerMethod_produceClaim_59Nwf11Pe6-tJ8sSdHBas2YBXZo_Bean
...
(
    ...
    ** label1
    ...
    PUTFIELD io/smallrye/jwt/auth/cdi/ClaimValueProducer_ProducerMethod_produceClaim_59Nwf11Pe6-tJ8sSdHBas2YBXZo_Bean#declaringProviderSupplier
    ...
    // Field descriptor: Ljava/util/function/Supplier;
    PUTFIELD io/smallrye/jwt/auth/cdi/ClaimValueProducer_ProducerMethod_produceClaim_59Nwf11Pe6-tJ8sSdHBas2YBXZo_Bean#injectProviderSupplier1
    ICONST_3
    ...
    PUTFIELD io/smallrye/jwt/auth/cdi/ClaimValueProducer_ProducerMethod_produceClaim_59Nwf11Pe6-tJ8sSdHBas2YBXZo_Bean#types
    ICONST_2
    ANEWARRAY java/lang/Object
    ASTORE 15
    ...
    ALOAD 19
    // Field descriptor: Ljava/util/Set;
    PUTFIELD io/smallrye/jwt/auth/cdi/ClaimValueProducer_ProducerMethod_produceClaim_59Nwf11Pe6-tJ8sSdHBas2YBXZo_Bean#qualifiers
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD io/smallrye/jwt/auth/cdi/ClaimValueProducer_ProducerMethod_produceClaim_59Nwf11Pe6-tJ8sSdHBas2YBXZo_Bean#declaringProviderSupplier
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD io/smallrye/jwt/auth/cdi/ClaimValueProducer_ProducerMethod_produceClaim_59Nwf11Pe6-tJ8sSdHBas2YBXZo_Bean#injectProviderSupplier1
    // Method descriptor: ()Ljava/lang/Object;
    INVOKEINTERFACE java/util/function/Supplier#get
    ASTORE 3
    ALOAD 3
...
(
    ...
    ** label2
    ...
    INVOKESPECIAL io/smallrye/jwt/auth/cdi/ClaimValueProducer_ProducerMethod_produceClaim_59Nwf11Pe6-tJ8sSdHBas2YBXZo_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lorg/eclipse/microprofile/jwt/ClaimValue;
    INVOKEVIRTUAL io/smallrye/jwt/auth/cdi/ClaimValueProducer_ProducerMethod_produceClaim_59Nwf11Pe6-tJ8sSdHBas2YBXZo_Bean#create
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lorg/eclipse/microprofile/jwt/ClaimValue;
    INVOKEVIRTUAL io/smallrye/jwt/auth/cdi/ClaimValueProducer_ProducerMethod_produceClaim_59Nwf11Pe6-tJ8sSdHBas2YBXZo_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/smallrye/jwt/auth/cdi/ClaimValueProducer_ProducerMethod_produceClaim_59Nwf11Pe6-tJ8sSdHBas2YBXZo_Bean#types
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/smallrye/jwt/auth/cdi/ClaimValueProducer_ProducerMethod_produceClaim_59Nwf11Pe6-tJ8sSdHBas2YBXZo_Bean#qualifiers
    ARETURN
    ** label2
