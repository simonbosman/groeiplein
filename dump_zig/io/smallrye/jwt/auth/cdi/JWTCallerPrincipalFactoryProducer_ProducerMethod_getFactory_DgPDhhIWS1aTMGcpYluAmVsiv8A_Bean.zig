// Class: io/smallrye/jwt/auth/cdi/JWTCallerPrincipalFactoryProducer_ProducerMethod_getFactory_DgPDhhIWS1aTMGcpYluAmVsiv8A_Bean
...
(
    ...
    ** label1
    ...
    PUTFIELD io/smallrye/jwt/auth/cdi/JWTCallerPrincipalFactoryProducer_ProducerMethod_getFactory_DgPDhhIWS1aTMGcpYluAmVsiv8A_Bean#declaringProviderSupplier
    ICONST_2
    ...
    PUTFIELD io/smallrye/jwt/auth/cdi/JWTCallerPrincipalFactoryProducer_ProducerMethod_getFactory_DgPDhhIWS1aTMGcpYluAmVsiv8A_Bean#types
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD io/smallrye/jwt/auth/cdi/JWTCallerPrincipalFactoryProducer_ProducerMethod_getFactory_DgPDhhIWS1aTMGcpYluAmVsiv8A_Bean#declaringProviderSupplier
...
(
    ...
    ** label2
    ...
    INVOKESPECIAL io/smallrye/jwt/auth/cdi/JWTCallerPrincipalFactoryProducer_ProducerMethod_getFactory_DgPDhhIWS1aTMGcpYluAmVsiv8A_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/smallrye/jwt/auth/principal/JWTCallerPrincipalFactory;
    INVOKEVIRTUAL io/smallrye/jwt/auth/cdi/JWTCallerPrincipalFactoryProducer_ProducerMethod_getFactory_DgPDhhIWS1aTMGcpYluAmVsiv8A_Bean#create
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/smallrye/jwt/auth/principal/JWTCallerPrincipalFactory;
    INVOKEVIRTUAL io/smallrye/jwt/auth/cdi/JWTCallerPrincipalFactoryProducer_ProducerMethod_getFactory_DgPDhhIWS1aTMGcpYluAmVsiv8A_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/smallrye/jwt/auth/cdi/JWTCallerPrincipalFactoryProducer_ProducerMethod_getFactory_DgPDhhIWS1aTMGcpYluAmVsiv8A_Bean#types
    ARETURN
    ** label2
