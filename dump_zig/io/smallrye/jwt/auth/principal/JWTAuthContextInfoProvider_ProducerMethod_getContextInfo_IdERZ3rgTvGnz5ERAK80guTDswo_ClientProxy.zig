// Class: io/smallrye/jwt/auth/principal/JWTAuthContextInfoProvider_ProducerMethod_getContextInfo_IdERZ3rgTvGnz5ERAK80guTDswo_ClientProxy
...
(
    ...
    ** label1
    ...
    PUTFIELD io/smallrye/jwt/auth/principal/JWTAuthContextInfoProvider_ProducerMethod_getContextInfo_IdERZ3rgTvGnz5ERAK80guTDswo_ClientProxy#bean
    ALOAD 2
    ...
    PUTFIELD io/smallrye/jwt/auth/principal/JWTAuthContextInfoProvider_ProducerMethod_getContextInfo_IdERZ3rgTvGnz5ERAK80guTDswo_ClientProxy#context
    RETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableBean;
    GETFIELD io/smallrye/jwt/auth/principal/JWTAuthContextInfoProvider_ProducerMethod_getContextInfo_IdERZ3rgTvGnz5ERAK80guTDswo_ClientProxy#bean
    ASTORE 1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD io/smallrye/jwt/auth/principal/JWTAuthContextInfoProvider_ProducerMethod_getContextInfo_IdERZ3rgTvGnz5ERAK80guTDswo_ClientProxy#context
    ALOAD 1
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/smallrye/jwt/auth/principal/JWTAuthContextInfoProvider_ProducerMethod_getContextInfo_IdERZ3rgTvGnz5ERAK80guTDswo_ClientProxy#arc$delegate
    ARETURN
    ** label2
...
TAuthContextInfoProvider_ProducerMethod_getContextInfo_IdERZ3rgTvGnz5ERAK80guTDswo_ClientProxy#arc$delegate
    ALOAD 1
    // Method descriptor: (Ljava/util/Set;)V
    INVOKEVIRTUAL io/smallrye/jwt/auth/principal/JWTAuthContextInfo#setTlsTrustedHosts
    RETURN
