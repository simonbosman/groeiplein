// Class: io/smallrye/jwt/KeyFormat_RtbZfMDHJMtCQQpNBnm5j3D_oR0_Synthetic_Bean
...
(
    ...
    ** label1
    ...
    PUTFIELD io/smallrye/jwt/KeyFormat_RtbZfMDHJMtCQQpNBnm5j3D_oR0_Synthetic_Bean#types
    ICONST_2
    ANEWARRAY java/lang/Object
    ASTORE 6
    ...
    ALOAD 9
    // Field descriptor: Ljava/util/Set;
    PUTFIELD io/smallrye/jwt/KeyFormat_RtbZfMDHJMtCQQpNBnm5j3D_oR0_Synthetic_Bean#qualifiers
    ...
    PUTFIELD io/smallrye/jwt/KeyFormat_RtbZfMDHJMtCQQpNBnm5j3D_oR0_Synthetic_Bean#params
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/Map;
    GETFIELD io/smallrye/jwt/KeyFormat_RtbZfMDHJMtCQQpNBnm5j3D_oR0_Synthetic_Bean#params
    ASTORE 2
    ...
    ** label2
    ...
    INVOKEVIRTUAL io/smallrye/jwt/KeyFormat_RtbZfMDHJMtCQQpNBnm5j3D_oR0_Synthetic_Bean#createSynthetic
    ASTORE 9
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label2
    ...
    INVOKESPECIAL io/smallrye/jwt/KeyFormat_RtbZfMDHJMtCQQpNBnm5j3D_oR0_Synthetic_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/smallrye/jwt/KeyFormat;
    INVOKEVIRTUAL io/smallrye/jwt/KeyFormat_RtbZfMDHJMtCQQpNBnm5j3D_oR0_Synthetic_Bean#create
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/smallrye/jwt/KeyFormat;
    INVOKEVIRTUAL io/smallrye/jwt/KeyFormat_RtbZfMDHJMtCQQpNBnm5j3D_oR0_Synthetic_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/smallrye/jwt/KeyFormat_RtbZfMDHJMtCQQpNBnm5j3D_oR0_Synthetic_Bean#types
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/smallrye/jwt/KeyFormat_RtbZfMDHJMtCQQpNBnm5j3D_oR0_Synthetic_Bean#qualifiers
    ARETURN
    ** label2
