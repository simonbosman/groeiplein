// Class: io/smallrye/config/inject/ConfigProducer_ProducerMethod_produceOptionalConfigProperty_5479b69962c68409eaef9cd1b7e056c935aefc81_Bean
...
(
    ...
    ** label1
    ...
    PUTFIELD io/smallrye/config/inject/ConfigProducer_ProducerMethod_produceOptionalConfigProperty_5479b69962c68409eaef9cd1b7e056c935aefc81_Bean#declaringProviderSupplier
    ...
    // Field descriptor: Ljava/util/function/Supplier;
    PUTFIELD io/smallrye/config/inject/ConfigProducer_ProducerMethod_produceOptionalConfigProperty_5479b69962c68409eaef9cd1b7e056c935aefc81_Bean#injectProviderSupplier1
    ICONST_2
    ...
    PUTFIELD io/smallrye/config/inject/ConfigProducer_ProducerMethod_produceOptionalConfigProperty_5479b69962c68409eaef9cd1b7e056c935aefc81_Bean#types
    ICONST_2
    ANEWARRAY java/lang/Object
    ASTORE 12
    ...
    ALOAD 15
    // Field descriptor: Ljava/util/Set;
    PUTFIELD io/smallrye/config/inject/ConfigProducer_ProducerMethod_produceOptionalConfigProperty_5479b69962c68409eaef9cd1b7e056c935aefc81_Bean#qualifiers
    RETURN
    ** label2
...
// Access: private
Method doCreate : Ljava/util/Optional;
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD io/smallrye/config/inject/ConfigProducer_ProducerMethod_produceOptionalConfigProperty_5479b69962c68409eaef9cd1b7e056c935aefc81_Bean#declaringProviderSupplier
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD io/smallrye/config/inject/ConfigProducer_ProducerMethod_produceOptionalConfigProperty_5479b69962c68409eaef9cd1b7e056c935aefc81_Bean#injectProviderSupplier1
    // Method descriptor: ()Ljava/lang/Object;
    INVOKEINTERFACE java/util/function/Supplier#get
    ASTORE 3
    ALOAD 3
...
// Access: public
Method create : Ljava/util/Optional;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Ljava/util/Optional;
    INVOKESPECIAL io/smallrye/config/inject/ConfigProducer_ProducerMethod_produceOptionalConfigProperty_5479b69962c68409eaef9cd1b7e056c935aefc81_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Ljava/util/Optional;
    INVOKEVIRTUAL io/smallrye/config/inject/ConfigProducer_ProducerMethod_produceOptionalConfigProperty_5479b69962c68409eaef9cd1b7e056c935aefc81_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Ljava/util/Optional;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Ljava/util/Optional;
    INVOKEVIRTUAL io/smallrye/config/inject/ConfigProducer_ProducerMethod_produceOptionalConfigProperty_5479b69962c68409eaef9cd1b7e056c935aefc81_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/smallrye/config/inject/ConfigProducer_ProducerMethod_produceOptionalConfigProperty_5479b69962c68409eaef9cd1b7e056c935aefc81_Bean#types
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/smallrye/config/inject/ConfigProducer_ProducerMethod_produceOptionalConfigProperty_5479b69962c68409eaef9cd1b7e056c935aefc81_Bean#qualifiers
    ARETURN
    ** label2
