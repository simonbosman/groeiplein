// Class: io/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_Bean
...
Field proxy : Lio/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_ClientProxy;

// Access: private final
Field params : Ljava/util/Map;

// Access: private
Method proxy : Lio/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_ClientProxy;
(
    // (no arguments)
) {
    ** label1
    ALOAD 0
    // Field descriptor: Lio/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_ClientProxy;
    GETFIELD io/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_Bean#proxy
    ASTORE 1
    ALOAD 1
    IFNULL label2
    ** label3
    ** label4
    GOTO label5
    ** label2
    NEW io/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_ClientProxy
    DUP
    LDC (String) "lqKjJdjCAn5-NiGWRGO66qxz_A8"
    // Method descriptor: (Ljava/lang/String;)V
    INVOKESPECIAL io/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_ClientProxy#<init>
    ASTORE 1
    ALOAD 0
    ALOAD 1
    // Field descriptor: Lio/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_ClientProxy;
    PUTFIELD io/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_Bean#proxy
    ** label5
    ALOAD 1
    ARETURN
    ** label6
...
(
    ...
    ** label1
    ...
    PUTFIELD io/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_Bean#types
    ...
    PUTFIELD io/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_Bean#params
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/Map;
    GETFIELD io/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_Bean#params
    ASTORE 2
    ...
    ** label2
    ...
    INVOKEVIRTUAL io/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_Bean#createSynthetic
    ASTORE 9
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label2
    ...
    INVOKESPECIAL io/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/quarkiverse/bucket4j/runtime/BucketPodStorage;
    INVOKEVIRTUAL io/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_Bean#create
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Method descriptor: ()Lio/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_ClientProxy;
    INVOKEVIRTUAL io/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_Bean#proxy
    CHECKCAST io/quarkiverse/bucket4j/runtime/BucketPodStorage
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/quarkiverse/bucket4j/runtime/BucketPodStorage;
    INVOKEVIRTUAL io/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/quarkiverse/bucket4j/runtime/BucketPodStorage_lqKjJdjCAn5-NiGWRGO66qxz_A8_Synthetic_Bean#types
    ARETURN
    ** label2
