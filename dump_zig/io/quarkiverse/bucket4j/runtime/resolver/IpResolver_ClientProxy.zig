...
(
    ...
    ** label1
    ...
    PUTFIELD io/quarkiverse/bucket4j/runtime/resolver/IpResolver_ClientProxy#context
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD io/quarkiverse/bucket4j/runtime/resolver/IpResolver_ClientProxy#context
    ALOAD 1
...
()Lio/quarkiverse/bucket4j/runtime/resolver/IpResolver;
    INVOKEVIRTUAL io/quarkiverse/bucket4j/runtime/resolver/IpResolver_ClientProxy#arc$delegate
    // Method descriptor: ()Ljava/lang/String;
    INVOKEVIRTUAL java/lang/Object#toString
    ARETURN
