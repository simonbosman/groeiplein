// Class: io/quarkus/vertx/runtime/VertxProducer_ProducerMethod_mutinyEventBus_Zfz34fPj7emiL2kcpwNmuVZMeq0_Bean
...
(
    ...
    ** label1
    ...
    PUTFIELD io/quarkus/vertx/runtime/VertxProducer_ProducerMethod_mutinyEventBus_Zfz34fPj7emiL2kcpwNmuVZMeq0_Bean#declaringProviderSupplier
    ALOAD 0
    ALOAD 2
    // Field descriptor: Ljava/util/function/Supplier;
    PUTFIELD io/quarkus/vertx/runtime/VertxProducer_ProducerMethod_mutinyEventBus_Zfz34fPj7emiL2kcpwNmuVZMeq0_Bean#injectProviderSupplier1
    ICONST_3
    ...
    PUTFIELD io/quarkus/vertx/runtime/VertxProducer_ProducerMethod_mutinyEventBus_Zfz34fPj7emiL2kcpwNmuVZMeq0_Bean#types
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD io/quarkus/vertx/runtime/VertxProducer_ProducerMethod_mutinyEventBus_Zfz34fPj7emiL2kcpwNmuVZMeq0_Bean#declaringProviderSupplier
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD io/quarkus/vertx/runtime/VertxProducer_ProducerMethod_mutinyEventBus_Zfz34fPj7emiL2kcpwNmuVZMeq0_Bean#injectProviderSupplier1
    // Method descriptor: ()Ljava/lang/Object;
    INVOKEINTERFACE java/util/function/Supplier#get
    ASTORE 3
    ALOAD 3
...
(
    ...
    ** label2
    ...
    INVOKESPECIAL io/quarkus/vertx/runtime/VertxProducer_ProducerMethod_mutinyEventBus_Zfz34fPj7emiL2kcpwNmuVZMeq0_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/vertx/mutiny/core/eventbus/EventBus;
    INVOKEVIRTUAL io/quarkus/vertx/runtime/VertxProducer_ProducerMethod_mutinyEventBus_Zfz34fPj7emiL2kcpwNmuVZMeq0_Bean#create
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/vertx/mutiny/core/eventbus/EventBus;
    INVOKEVIRTUAL io/quarkus/vertx/runtime/VertxProducer_ProducerMethod_mutinyEventBus_Zfz34fPj7emiL2kcpwNmuVZMeq0_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/quarkus/vertx/runtime/VertxProducer_ProducerMethod_mutinyEventBus_Zfz34fPj7emiL2kcpwNmuVZMeq0_Bean#types
    ARETURN
    ** label2
