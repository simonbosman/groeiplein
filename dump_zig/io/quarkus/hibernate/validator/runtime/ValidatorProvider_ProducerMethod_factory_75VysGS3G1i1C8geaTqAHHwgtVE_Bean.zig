// Class: io/quarkus/hibernate/validator/runtime/ValidatorProvider_ProducerMethod_factory_75VysGS3G1i1C8geaTqAHHwgtVE_Bean
...
(
    ...
    ** label1
    ...
    PUTFIELD io/quarkus/hibernate/validator/runtime/ValidatorProvider_ProducerMethod_factory_75VysGS3G1i1C8geaTqAHHwgtVE_Bean#declaringProviderSupplier
    ICONST_4
    ...
    PUTFIELD io/quarkus/hibernate/validator/runtime/ValidatorProvider_ProducerMethod_factory_75VysGS3G1i1C8geaTqAHHwgtVE_Bean#types
    ICONST_3
    ANEWARRAY java/lang/Object
    ASTORE 9
    ...
    ALOAD 13
    // Field descriptor: Ljava/util/Set;
    PUTFIELD io/quarkus/hibernate/validator/runtime/ValidatorProvider_ProducerMethod_factory_75VysGS3G1i1C8geaTqAHHwgtVE_Bean#qualifiers
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD io/quarkus/hibernate/validator/runtime/ValidatorProvider_ProducerMethod_factory_75VysGS3G1i1C8geaTqAHHwgtVE_Bean#declaringProviderSupplier
...
(
    ...
    ** label2
    ...
    INVOKESPECIAL io/quarkus/hibernate/validator/runtime/ValidatorProvider_ProducerMethod_factory_75VysGS3G1i1C8geaTqAHHwgtVE_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lorg/hibernate/validator/HibernateValidatorFactory;
    INVOKEVIRTUAL io/quarkus/hibernate/validator/runtime/ValidatorProvider_ProducerMethod_factory_75VysGS3G1i1C8geaTqAHHwgtVE_Bean#create
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lorg/hibernate/validator/HibernateValidatorFactory;
    INVOKEVIRTUAL io/quarkus/hibernate/validator/runtime/ValidatorProvider_ProducerMethod_factory_75VysGS3G1i1C8geaTqAHHwgtVE_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/quarkus/hibernate/validator/runtime/ValidatorProvider_ProducerMethod_factory_75VysGS3G1i1C8geaTqAHHwgtVE_Bean#types
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/quarkus/hibernate/validator/runtime/ValidatorProvider_ProducerMethod_factory_75VysGS3G1i1C8geaTqAHHwgtVE_Bean#qualifiers
    ARETURN
    ** label2
