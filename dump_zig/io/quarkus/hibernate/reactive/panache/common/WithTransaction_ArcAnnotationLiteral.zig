// Class: io/quarkus/hibernate/reactive/panache/common/WithTransaction_ArcAnnotationLiteral
...
Field INSTANCE : Lio/quarkus/hibernate/reactive/panache/common/WithTransaction_ArcAnnotationLiteral;
...
(
    ...
    ** label1
    LDC (Type) Lio/quarkus/hibernate/reactive/panache/common/WithTransaction;
    ARETURN
    ** label2
...
(
    ...
    ** label1
    NEW io/quarkus/hibernate/reactive/panache/common/WithTransaction_ArcAnnotationLiteral
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL io/quarkus/hibernate/reactive/panache/common/WithTransaction_ArcAnnotationLiteral#<init>
    // Field descriptor: Lio/quarkus/hibernate/reactive/panache/common/WithTransaction_ArcAnnotationLiteral;
    PUTSTATIC io/quarkus/hibernate/reactive/panache/common/WithTransaction_ArcAnnotationLiteral#INSTANCE
    RETURN
    ** label2
...
(
    ...
    ** label9
    ...
    IRETURN
    ALOAD 1
    INSTANCEOF io/quarkus/hibernate/reactive/panache/common/WithTransaction
    IFNE label10
    ** label11
    ICONST_0
    IRETURN
    ...
    ** label13
    ALOAD 1
    CHECKCAST io/quarkus/hibernate/reactive/panache/common/WithTransaction
    POP
    ICONST_1
    IRETURN
    ** label14
