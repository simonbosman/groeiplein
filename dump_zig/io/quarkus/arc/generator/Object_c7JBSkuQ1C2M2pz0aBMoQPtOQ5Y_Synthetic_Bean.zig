// Class: io/quarkus/arc/generator/Object_c7JBSkuQ1C2M2pz0aBMoQPtOQ5Y_Synthetic_Bean
...
(
    ...
    ** label1
    ...
    PUTFIELD io/quarkus/arc/generator/Object_c7JBSkuQ1C2M2pz0aBMoQPtOQ5Y_Synthetic_Bean#types
    ICONST_2
    ANEWARRAY java/lang/Object
    ASTORE 6
    ...
    GETSTATIC io/quarkus/runtime/annotations/CommandLineArguments_ArcAnnotationLiteral#INSTANCE
    ASTORE 8
    ALOAD 6
    ICONST_1
    ALOAD 8
    ...
    ALOAD 9
    // Field descriptor: Ljava/util/Set;
    PUTFIELD io/quarkus/arc/generator/Object_c7JBSkuQ1C2M2pz0aBMoQPtOQ5Y_Synthetic_Bean#qualifiers
    ...
    PUTFIELD io/quarkus/arc/generator/Object_c7JBSkuQ1C2M2pz0aBMoQPtOQ5Y_Synthetic_Bean#params
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/Map;
    GETFIELD io/quarkus/arc/generator/Object_c7JBSkuQ1C2M2pz0aBMoQPtOQ5Y_Synthetic_Bean#params
    ASTORE 2
    ...
    ** label2
    ...
    // Method descriptor: (Lio/quarkus/arc/SyntheticCreationalContext;)[Ljava/lang/String;
    INVOKEVIRTUAL io/quarkus/arc/generator/Object_c7JBSkuQ1C2M2pz0aBMoQPtOQ5Y_Synthetic_Bean#createSynthetic
    ASTORE 9
    ** label3
    GOTO label4
    ** label5
...
// Access: private
Method createSynthetic : [Ljava/lang/String;
(
    ...
    ** label2
    NEW jakarta/enterprise/inject/CreationException
    DUP
    LDC (String) "Synthetic bean instance for java.lang.Object not initialized yet: java_lang_Object_b49eef409da9bd88621c260e1a58c4aaaa2f771a
...
(
    ...
    ** label2
    ...
    INVOKESPECIAL io/quarkus/arc/generator/Object_c7JBSkuQ1C2M2pz0aBMoQPtOQ5Y_Synthetic_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)[Ljava/lang/String;
    INVOKEVIRTUAL io/quarkus/arc/generator/Object_c7JBSkuQ1C2M2pz0aBMoQPtOQ5Y_Synthetic_Bean#create
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)[Ljava/lang/String;
    INVOKEVIRTUAL io/quarkus/arc/generator/Object_c7JBSkuQ1C2M2pz0aBMoQPtOQ5Y_Synthetic_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/quarkus/arc/generator/Object_c7JBSkuQ1C2M2pz0aBMoQPtOQ5Y_Synthetic_Bean#types
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/quarkus/arc/generator/Object_c7JBSkuQ1C2M2pz0aBMoQPtOQ5Y_Synthetic_Bean#qualifiers
    ARETURN
    ** label2
