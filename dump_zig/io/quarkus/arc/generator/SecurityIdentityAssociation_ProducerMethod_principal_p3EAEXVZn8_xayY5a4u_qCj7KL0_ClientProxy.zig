// Class: io/quarkus/arc/generator/SecurityIdentityAssociation_ProducerMethod_principal_p3EAEXVZn8_xayY5a4u_qCj7KL0_ClientProxy
...
(
    ...
    ** label1
    ...
    PUTFIELD io/quarkus/arc/generator/SecurityIdentityAssociation_ProducerMethod_principal_p3EAEXVZn8_xayY5a4u_qCj7KL0_ClientProxy#bean
    ALOAD 2
    ...
    PUTFIELD io/quarkus/arc/generator/SecurityIdentityAssociation_ProducerMethod_principal_p3EAEXVZn8_xayY5a4u_qCj7KL0_ClientProxy#context
    RETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableBean;
    GETFIELD io/quarkus/arc/generator/SecurityIdentityAssociation_ProducerMethod_principal_p3EAEXVZn8_xayY5a4u_qCj7KL0_ClientProxy#bean
    ASTORE 1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD io/quarkus/arc/generator/SecurityIdentityAssociation_ProducerMethod_principal_p3EAEXVZn8_xayY5a4u_qCj7KL0_ClientProxy#context
    ALOAD 1
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/arc/generator/SecurityIdentityAssociation_ProducerMethod_principal_p3EAEXVZn8_xayY5a4u_qCj7KL0_ClientProxy#arc$delegate
    ARETURN
    ** label2
...
RTUAL io/quarkus/arc/generator/SecurityIdentityAssociation_ProducerMethod_principal_p3EAEXVZn8_xayY5a4u_qCj7KL0_ClientProxy#arc$delegate
    ALOAD 1
    // Method descriptor: (Ljavax/security/auth/Subject;)Z
    INVOKEINTERFACE java/security/Principal#implies
    IRETURN
