// Class: io/quarkus/arc/log/LoggerName_ArcAnnotationLiteral
...
(
    ...
    ** label1
    ...
    PUTFIELD io/quarkus/arc/log/LoggerName_ArcAnnotationLiteral#value
    RETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/lang/String;
    GETFIELD io/quarkus/arc/log/LoggerName_ArcAnnotationLiteral#value
    ARETURN
    ** label2
...
(
    ...
    ** label1
    LDC (Type) Lio/quarkus/arc/log/LoggerName;
    ARETURN
    ** label2
...
(
    ...
    ** label5
    ALOAD 1
    INSTANCEOF io/quarkus/arc/log/LoggerName
    IFNE label6
    ** label7
    ICONST_0
    IRETURN
    ...
    ** label9
    ALOAD 1
    CHECKCAST io/quarkus/arc/log/LoggerName
    ASTORE 2
    ALOAD 0
    // Field descriptor: Ljava/lang/String;
    GETFIELD io/quarkus/arc/log/LoggerName_ArcAnnotationLiteral#value
    ...
    INVOKEINTERFACE io/quarkus/arc/log/LoggerName#value
    ASTORE 4
    ALOAD 3
    ALOAD 4
