// Class: io/quarkus/arc/runtime/ConfigStaticInitValues_Observer_onStart_9AFRg-nRqgtTxnkBRkFamSX9SUE
...
(
    ...
    ** label1
    ...
    PUTFIELD io/quarkus/arc/runtime/ConfigStaticInitValues_Observer_onStart_9AFRg-nRqgtTxnkBRkFamSX9SUE#declaringProviderSupplier
    ...
    PUTFIELD io/quarkus/arc/runtime/ConfigStaticInitValues_Observer_onStart_9AFRg-nRqgtTxnkBRkFamSX9SUE#observedType
    RETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/lang/reflect/Type;
    GETFIELD io/quarkus/arc/runtime/ConfigStaticInitValues_Observer_onStart_9AFRg-nRqgtTxnkBRkFamSX9SUE#observedType
    ARETURN
    ** label2
...
(
    ...
    ** label1
    LDC (Type) Lio/quarkus/arc/runtime/ConfigStaticInitValues;
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD io/quarkus/arc/runtime/ConfigStaticInitValues_Observer_onStart_9AFRg-nRqgtTxnkBRkFamSX9SUE#declaringProviderSupplier
    ...
    ** label9
    ...
    INVOKEVIRTUAL io/quarkus/arc/runtime/ConfigStaticInitValues#onStart
    RETURN
    ** label10
...
(
    ...
    ** label1
    LDC (String) "Observer [method=io.quarkus.arc.runtime.ConfigStaticInitValues#onStart(io.quarkus.runtime.StartupEvent)]"
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ICONST_0
    // Field descriptor: Z
    PUTFIELD io/quarkus/arc/runtime/ConfigStaticInitValues_Observer_onStart_9AFRg-nRqgtTxnkBRkFamSX9SUE#mock
    RETURN
    ** label2
