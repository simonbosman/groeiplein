// Class: io/quarkus/arc/runtime/ConfigStaticInitCheck_ArcAnnotationLiteral
...
Field INSTANCE : Lio/quarkus/arc/runtime/ConfigStaticInitCheck_ArcAnnotationLiteral;
...
(
    ...
    ** label1
    LDC (Type) Lio/quarkus/arc/runtime/ConfigStaticInitCheck;
    ARETURN
    ** label2
...
(
    ...
    ** label1
    NEW io/quarkus/arc/runtime/ConfigStaticInitCheck_ArcAnnotationLiteral
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL io/quarkus/arc/runtime/ConfigStaticInitCheck_ArcAnnotationLiteral#<init>
    // Field descriptor: Lio/quarkus/arc/runtime/ConfigStaticInitCheck_ArcAnnotationLiteral;
    PUTSTATIC io/quarkus/arc/runtime/ConfigStaticInitCheck_ArcAnnotationLiteral#INSTANCE
    RETURN
    ** label2
...
(
    ...
    ** label9
    ...
    IRETURN
    ALOAD 1
    INSTANCEOF io/quarkus/arc/runtime/ConfigStaticInitCheck
    IFNE label10
    ** label11
    ICONST_0
    IRETURN
    ...
    ** label13
    ALOAD 1
    CHECKCAST io/quarkus/arc/runtime/ConfigStaticInitCheck
    POP
    ICONST_1
    IRETURN
    ** label14
