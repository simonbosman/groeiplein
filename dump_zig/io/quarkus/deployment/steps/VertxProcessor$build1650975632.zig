// Class: io/quarkus/deployment/steps/VertxProcessor$build1650975632
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxProcessor$build1650975632#$quarkus$createArray
    ASTORE 2
    ALOAD 0
    ALOAD 1
    ALOAD 2
    // Method descriptor: (Lio/quarkus/runtime/StartupContext;[Ljava/lang/Object;)V
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxProcessor$build1650975632#deploy_0
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    // Method descriptor: (Ljava/util/function/Supplier;Ljava/util/Map;Lio/quarkus/runtime/LaunchMode;Lio/quarkus/runtime/ShutdownContext;Ljava/util/Map;Ljava/util/List;)V
