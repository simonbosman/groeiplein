// Class: io/quarkus/deployment/steps/HibernateOrmCdiProcessor$generateJpaConfigBean206468564
...
(
    ...
    ** label1
    ALOAD 1
    LDC (String) "HibernateOrmCdiProcessor.generateJpaConfigBean"
    // Method descriptor: (Ljava/lang/String;)V
    INVOKEVIRTUAL io/quarkus/runtime/StartupContext#setCurrentBuildStepName
    ALOAD 0
    // Method descriptor: ()[Ljava/lang/Object;
    INVOKEVIRTUAL io/quarkus/deployment/steps/HibernateOrmCdiProcessor$generateJpaConfigBean206468564#$quarkus$createArray
    ASTORE 2
    ALOAD 0
    ALOAD 1
    ALOAD 2
    // Method descriptor: (Lio/quarkus/runtime/StartupContext;[Ljava/lang/Object;)V
    INVOKEVIRTUAL io/quarkus/deployment/steps/HibernateOrmCdiProcessor$generateJpaConfigBean206468564#deploy_0
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 39
    ALOAD 40
    // Method descriptor: (Lio/quarkus/hibernate/orm/runtime/HibernateOrmRuntimeConfig;)Ljava/util/function/Supplier;
    INVOKEVIRTUAL io/quarkus/hibernate/orm/runtime/HibernateOrmRecorder#jpaConfigSupplier
    ASTORE 41
    ALOAD 1
    LDC (String) "proxykey54"
    ALOAD 41
