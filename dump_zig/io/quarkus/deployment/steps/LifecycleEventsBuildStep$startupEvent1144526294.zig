...
(
    ...
    ** label1
    ALOAD 1
    LDC (String) "LifecycleEventsBuildStep.startupEvent"
    // Method descriptor: (Ljava/lang/String;)V
    INVOKEVIRTUAL io/quarkus/runtime/StartupContext#setCurrentBuildStepName
    ALOAD 0
    // Method descriptor: ()[Ljava/lang/Object;
    INVOKEVIRTUAL io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent1144526294#$quarkus$createArray
    ASTORE 2
    ALOAD 0
    ALOAD 1
    ALOAD 2
    // Method descriptor: (Lio/quarkus/runtime/StartupContext;[Ljava/lang/Object;)V
    INVOKEVIRTUAL io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent1144526294#deploy_0
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 5
    ICONST_0
    // Method descriptor: (Lio/quarkus/runtime/ShutdownContext;Lio/quarkus/runtime/LaunchMode;Z)V
