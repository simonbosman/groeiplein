// Class: io/quarkus/deployment/steps/ArcProcessor$initializeContainer1770303700
...
(
    ...
    ** label1
    ALOAD 1
    LDC (String) "ArcProcessor.initializeContainer"
    // Method descriptor: (Ljava/lang/String;)V
    INVOKEVIRTUAL io/quarkus/runtime/StartupContext#setCurrentBuildStepName
    ALOAD 0
    // Method descriptor: ()[Ljava/lang/Object;
    INVOKEVIRTUAL io/quarkus/deployment/steps/ArcProcessor$initializeContainer1770303700#$quarkus$createArray
    ASTORE 2
    ALOAD 0
    ALOAD 1
    ALOAD 2
    // Method descriptor: (Lio/quarkus/runtime/StartupContext;[Ljava/lang/Object;)V
    INVOKEVIRTUAL io/quarkus/deployment/steps/ArcProcessor$initializeContainer1770303700#deploy_0
    RETURN
    ** label2
