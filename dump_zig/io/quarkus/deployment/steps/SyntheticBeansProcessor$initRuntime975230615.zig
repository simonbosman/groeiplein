...
(
    ...
    ** label1
    ...
    ALOAD 30
    CHECKCAST java/util/Map
    LDC (String) "java_util_concurrent_ExecutorService_5c890da2586422cd5c2dcc05d69bab75eda938b4"
    ALOAD 36
    // Method descriptor: (Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    INVOKEINTERFACE java/util/Map#put
    POP
...
s$createArray : [Ljava/lang/Object;
(
    // (no arguments)
) {
    ** label1
