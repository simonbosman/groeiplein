...
(
    ...
    ** label1
    ...
    PUTFIELD io/quarkus/resteasy/reactive/links/runtime/hal/ResteasyReactiveHalService_ClientProxy#context
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD io/quarkus/resteasy/reactive/links/runtime/hal/ResteasyReactiveHalService_ClientProxy#context
    ALOAD 1
