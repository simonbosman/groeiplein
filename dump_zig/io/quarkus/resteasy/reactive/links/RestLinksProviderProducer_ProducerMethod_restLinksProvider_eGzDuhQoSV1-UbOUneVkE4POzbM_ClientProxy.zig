// Class: io/quarkus/resteasy/reactive/links/RestLinksProviderProducer_ProducerMethod_restLinksProvider_eGzDuhQoSV1-UbOUneVkE4POzbM_ClientProxy
...
(
    ...
    ** label1
    ...
    PUTFIELD io/quarkus/resteasy/reactive/links/RestLinksProviderProducer_ProducerMethod_restLinksProvider_eGzDuhQoSV1-UbOUneVkE4POzbM_ClientProxy#bean
    ALOAD 2
    ...
    PUTFIELD io/quarkus/resteasy/reactive/links/RestLinksProviderProducer_ProducerMethod_restLinksProvider_eGzDuhQoSV1-UbOUneVkE4POzbM_ClientProxy#context
    RETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableBean;
    GETFIELD io/quarkus/resteasy/reactive/links/RestLinksProviderProducer_ProducerMethod_restLinksProvider_eGzDuhQoSV1-UbOUneVkE4POzbM_ClientProxy#bean
    ASTORE 1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD io/quarkus/resteasy/reactive/links/RestLinksProviderProducer_ProducerMethod_restLinksProvider_eGzDuhQoSV1-UbOUneVkE4POzbM_ClientProxy#context
    ALOAD 1
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/resteasy/reactive/links/RestLinksProviderProducer_ProducerMethod_restLinksProvider_eGzDuhQoSV1-UbOUneVkE4POzbM_ClientProxy#arc$delegate
    ARETURN
    ** label2
...
nksProvider_eGzDuhQoSV1-UbOUneVkE4POzbM_ClientProxy#arc$delegate
    // Method descriptor: ()Ljava/lang/String;
    INVOKEVIRTUAL java/lang/Object#toString
    ARETURN
    ** label2
