// Class: io/quarkus/netty/MainEventLoopGroup_ArcAnnotationLiteral
...
Field INSTANCE : Lio/quarkus/netty/MainEventLoopGroup_ArcAnnotationLiteral;
...
(
    ...
    ** label1
    LDC (Type) Lio/quarkus/netty/MainEventLoopGroup;
    ARETURN
    ** label2
...
(
    ...
    ** label1
    NEW io/quarkus/netty/MainEventLoopGroup_ArcAnnotationLiteral
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL io/quarkus/netty/MainEventLoopGroup_ArcAnnotationLiteral#<init>
    // Field descriptor: Lio/quarkus/netty/MainEventLoopGroup_ArcAnnotationLiteral;
    PUTSTATIC io/quarkus/netty/MainEventLoopGroup_ArcAnnotationLiteral#INSTANCE
    RETURN
    ** label2
...
(
    ...
    ** label9
    ...
    IRETURN
    ALOAD 1
    INSTANCEOF io/quarkus/netty/MainEventLoopGroup
    IFNE label10
    ** label11
    ICONST_0
    IRETURN
    ...
    ** label13
    ALOAD 1
    CHECKCAST io/quarkus/netty/MainEventLoopGroup
    POP
    ICONST_1
    IRETURN
    ** label14
