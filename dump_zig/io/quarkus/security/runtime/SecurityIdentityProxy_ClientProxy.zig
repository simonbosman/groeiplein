...
(
    ...
    ** label1
    ...
    PUTFIELD io/quarkus/security/runtime/SecurityIdentityProxy_ClientProxy#context
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD io/quarkus/security/runtime/SecurityIdentityProxy_ClientProxy#context
    ALOAD 1
