// Class: io/quarkus/security/identity/IdentityProviderManagerCreator_ProducerMethod_ipm_kfECvhsqeBIW24qB5qtLmxqE8Dw_ClientProxy
...
(
    ...
    ** label1
    ...
    PUTFIELD io/quarkus/security/identity/IdentityProviderManagerCreator_ProducerMethod_ipm_kfECvhsqeBIW24qB5qtLmxqE8Dw_ClientProxy#bean
    ALOAD 2
    ...
    PUTFIELD io/quarkus/security/identity/IdentityProviderManagerCreator_ProducerMethod_ipm_kfECvhsqeBIW24qB5qtLmxqE8Dw_ClientProxy#context
    RETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableBean;
    GETFIELD io/quarkus/security/identity/IdentityProviderManagerCreator_ProducerMethod_ipm_kfECvhsqeBIW24qB5qtLmxqE8Dw_ClientProxy#bean
    ASTORE 1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD io/quarkus/security/identity/IdentityProviderManagerCreator_ProducerMethod_ipm_kfECvhsqeBIW24qB5qtLmxqE8Dw_ClientProxy#context
    ALOAD 1
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/security/identity/IdentityProviderManagerCreator_ProducerMethod_ipm_kfECvhsqeBIW24qB5qtLmxqE8Dw_ClientProxy#arc$delegate
    ARETURN
    ** label2
...
us/security/identity/SecurityIdentity;
(
    arg 1 = Lio/quarkus/security/identity/request/AuthenticationRequest;
) {
    ** label1
