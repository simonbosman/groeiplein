// Class: io/quarkus/security/spi/runtime/SecurityCheckStorage_Pn4Vt51SJF9pyV1diz4pwHm0XFA_Synthetic_ClientProxy
...
(
    ...
    ** label1
    ...
    PUTFIELD io/quarkus/security/spi/runtime/SecurityCheckStorage_Pn4Vt51SJF9pyV1diz4pwHm0XFA_Synthetic_ClientProxy#bean
    ALOAD 2
    ...
    PUTFIELD io/quarkus/security/spi/runtime/SecurityCheckStorage_Pn4Vt51SJF9pyV1diz4pwHm0XFA_Synthetic_ClientProxy#context
    RETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableBean;
    GETFIELD io/quarkus/security/spi/runtime/SecurityCheckStorage_Pn4Vt51SJF9pyV1diz4pwHm0XFA_Synthetic_ClientProxy#bean
    ASTORE 1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD io/quarkus/security/spi/runtime/SecurityCheckStorage_Pn4Vt51SJF9pyV1diz4pwHm0XFA_Synthetic_ClientProxy#context
    ALOAD 1
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/security/spi/runtime/SecurityCheckStorage_Pn4Vt51SJF9pyV1diz4pwHm0XFA_Synthetic_ClientProxy#arc$delegate
    ARETURN
    ** label2
...
ityCheck : Lio/quarkus/security/spi/runtime/SecurityCheck;
(
    arg 1 = Ljava/lang/reflect/Method;
) {
    ** label1
