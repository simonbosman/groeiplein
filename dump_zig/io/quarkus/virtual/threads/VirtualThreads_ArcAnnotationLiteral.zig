// Class: io/quarkus/virtual/threads/VirtualThreads_ArcAnnotationLiteral
...
Field INSTANCE : Lio/quarkus/virtual/threads/VirtualThreads_ArcAnnotationLiteral;
...
(
    ...
    ** label1
    LDC (Type) Lio/quarkus/virtual/threads/VirtualThreads;
    ARETURN
    ** label2
...
(
    ...
    ** label1
    NEW io/quarkus/virtual/threads/VirtualThreads_ArcAnnotationLiteral
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL io/quarkus/virtual/threads/VirtualThreads_ArcAnnotationLiteral#<init>
    // Field descriptor: Lio/quarkus/virtual/threads/VirtualThreads_ArcAnnotationLiteral;
    PUTSTATIC io/quarkus/virtual/threads/VirtualThreads_ArcAnnotationLiteral#INSTANCE
    RETURN
    ** label2
...
(
    ...
    ** label9
    ...
    IRETURN
    ALOAD 1
    INSTANCEOF io/quarkus/virtual/threads/VirtualThreads
    IFNE label10
    ** label11
    ICONST_0
    IRETURN
    ...
    ** label13
    ALOAD 1
    CHECKCAST io/quarkus/virtual/threads/VirtualThreads
    POP
    ICONST_1
    IRETURN
    ** label14
