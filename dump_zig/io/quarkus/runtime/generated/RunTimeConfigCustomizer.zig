// Class: io/quarkus/runtime/generated/RunTimeConfigCustomizer
...
(
    ...
    ** label1
    ...
    // Method descriptor: (Lio/smallrye/config/SmallRyeConfigBuilder;Lio/smallrye/config/ConfigSourceInterceptor;)V
    INVOKESTATIC io/quarkus/runtime/configuration/AbstractConfigBuilder#withInterceptor
    NEW io/quarkus/config/yaml/runtime/ApplicationYamlConfigSourceLoader$InClassPath
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL io/quarkus/config/yaml/runtime/ApplicationYamlConfigSourceLoader$InClassPath#<init>
    ASTORE 16
    ALOAD 1
    ALOAD 16
    CHECKCAST org/eclipse/microprofile/config/spi/ConfigSourceProvider
    // Method descriptor: (Lio/smallrye/config/SmallRyeConfigBuilder;Lorg/eclipse/microprofile/config/spi/ConfigSourceProvider;)V
    INVOKESTATIC io/quarkus/runtime/configuration/AbstractConfigBuilder#withSource
    NEW io/quarkus/config/yaml/runtime/ApplicationYamlConfigSourceLoader$InFileSystem
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL io/quarkus/config/yaml/runtime/ApplicationYamlConfigSourceLoader$InFileSystem#<init>
    ASTORE 17
    ALOAD 1
    ALOAD 17
    CHECKCAST org/eclipse/microprofile/config/spi/ConfigSourceProvider
    // Method descriptor: (Lio/smallrye/config/SmallRyeConfigBuilder;Lorg/eclipse/microprofile/config/spi/ConfigSourceProvider;)V
    INVOKESTATIC io/quarkus/runtime/configuration/AbstractConfigBuilder#withSource
    NEW io/smallrye/config/source/yaml/YamlConfigSourceProvider
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL io/smallrye/config/source/yaml/YamlConfigSourceProvider#<init>
    ASTORE 18
    ALOAD 1
    ALOAD 18
    CHECKCAST org/eclipse/microprofile/config/spi/ConfigSourceProvider
    // Method descriptor: (Lio/smallrye/config/SmallRyeConfigBuilder;Lorg/eclipse/microprofile/config/spi/ConfigSourceProvider;)V
    INVOKESTATIC io/quarkus/runtime/configuration/AbstractConfigBuilder#withSource
    NEW io/smallrye/config/source/yaml/YamlLocationConfigSourceFactory
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL io/smallrye/config/source/yaml/YamlLocationConfigSourceFactory#<init>
    ASTORE 19
    ALOAD 1
    ALOAD 19
    CHECKCAST io/smallrye/config/ConfigSourceFactory
    // Method descriptor: (Lio/smallrye/config/SmallRyeConfigBuilder;Lio/smallrye/config/ConfigSourceFactory;)V
    INVOKESTATIC io/quarkus/runtime/configuration/AbstractConfigBuilder#withSource
    NEW io/smallrye/config/PropertiesLocationConfigSourceFactory
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL io/smallrye/config/PropertiesLocationConfigSourceFactory#<init>
    ASTORE 20
    ALOAD 1
    ALOAD 20
    CHECKCAST io/smallrye/config/ConfigSourceFactory
