// Class: io/quarkus/cache/runtime/CacheManagerInitializer_Observer_onStartup__CVBqD0NjoDpEUPVQRa_e8hFErY
...
(
    ...
    ** label1
    ...
    PUTFIELD io/quarkus/cache/runtime/CacheManagerInitializer_Observer_onStartup__CVBqD0NjoDpEUPVQRa_e8hFErY#declaringProviderSupplier
    ALOAD 0
    ALOAD 2
    // Field descriptor: Ljava/util/function/Supplier;
    PUTFIELD io/quarkus/cache/runtime/CacheManagerInitializer_Observer_onStartup__CVBqD0NjoDpEUPVQRa_e8hFErY#observerProviderSupplier1
    ...
    PUTFIELD io/quarkus/cache/runtime/CacheManagerInitializer_Observer_onStartup__CVBqD0NjoDpEUPVQRa_e8hFErY#observedType
    RETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/lang/reflect/Type;
    GETFIELD io/quarkus/cache/runtime/CacheManagerInitializer_Observer_onStartup__CVBqD0NjoDpEUPVQRa_e8hFErY#observedType
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD io/quarkus/cache/runtime/CacheManagerInitializer_Observer_onStartup__CVBqD0NjoDpEUPVQRa_e8hFErY#observerProviderSupplier1
    // Method descriptor: ()Ljava/lang/Object;
...
(
    ...
    ** label1
    ...
    ICONST_0
    // Field descriptor: Z
    PUTFIELD io/quarkus/cache/runtime/CacheManagerInitializer_Observer_onStartup__CVBqD0NjoDpEUPVQRa_e8hFErY#mock
    RETURN
    ** label2
