// Class: io/quarkus/cache/CacheManager_gav3xP1Xa1oNcPy1xyyVtm9vI-c_Synthetic_ClientProxy
...
(
    ...
    ** label1
    ...
    PUTFIELD io/quarkus/cache/CacheManager_gav3xP1Xa1oNcPy1xyyVtm9vI-c_Synthetic_ClientProxy#bean
    ALOAD 2
    ...
    PUTFIELD io/quarkus/cache/CacheManager_gav3xP1Xa1oNcPy1xyyVtm9vI-c_Synthetic_ClientProxy#context
    RETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableBean;
    GETFIELD io/quarkus/cache/CacheManager_gav3xP1Xa1oNcPy1xyyVtm9vI-c_Synthetic_ClientProxy#bean
    ASTORE 1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD io/quarkus/cache/CacheManager_gav3xP1Xa1oNcPy1xyyVtm9vI-c_Synthetic_ClientProxy#context
    ALOAD 1
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/cache/CacheManager_gav3xP1Xa1oNcPy1xyyVtm9vI-c_Synthetic_ClientProxy#arc$delegate
    ARETURN
    ** label2
...
tm9vI-c_Synthetic_ClientProxy#arc$delegate
    // Method descriptor: ()Ljava/lang/String;
    INVOKEVIRTUAL java/lang/Object#toString
    ARETURN
    ** label2
