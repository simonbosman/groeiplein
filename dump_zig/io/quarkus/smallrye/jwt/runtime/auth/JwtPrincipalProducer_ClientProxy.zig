...
(
    ...
    ** label1
    ...
    PUTFIELD io/quarkus/smallrye/jwt/runtime/auth/JwtPrincipalProducer_ClientProxy#context
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD io/quarkus/smallrye/jwt/runtime/auth/JwtPrincipalProducer_ClientProxy#context
    ALOAD 1
...
lrye/jwt/runtime/auth/JwtPrincipalProducer;
    INVOKEVIRTUAL io/quarkus/smallrye/jwt/runtime/auth/JwtPrincipalProducer_ClientProxy#arc$delegate
    // Method descriptor: ()Lorg/eclipse/microprofile/jwt/JsonWebToken;
    INVOKEVIRTUAL io/quarkus/smallrye/jwt/runtime/auth/JwtPrincipalProducer#currentJWTPrincipalOrNull
    ARETURN
