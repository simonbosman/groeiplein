...
(
    ...
    ** label1
    ...
    PUTFIELD io/quarkus/smallrye/jwt/runtime/auth/JsonWebTokenCredentialProducer_ClientProxy#context
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD io/quarkus/smallrye/jwt/runtime/auth/JsonWebTokenCredentialProducer_ClientProxy#context
    ALOAD 1
...
ye/jwt/runtime/auth/JsonWebTokenCredentialProducer_ClientProxy#arc$delegate
    // Method descriptor: ()Ljava/lang/String;
    INVOKEVIRTUAL java/lang/Object#toString
    ARETURN
    ** label6
