// Class: io/github/bucket4j/distributed/proxy/DefaultProxyManagerProducer_ProducerMethod_proxyManager_CFNfymUR1r4llnqJTYRFNNzlrFU_ClientProxy
...
(
    ...
    ** label1
    ...
    PUTFIELD io/github/bucket4j/distributed/proxy/DefaultProxyManagerProducer_ProducerMethod_proxyManager_CFNfymUR1r4llnqJTYRFNNzlrFU_ClientProxy#bean
    ALOAD 2
    ...
    PUTFIELD io/github/bucket4j/distributed/proxy/DefaultProxyManagerProducer_ProducerMethod_proxyManager_CFNfymUR1r4llnqJTYRFNNzlrFU_ClientProxy#context
    RETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableBean;
    GETFIELD io/github/bucket4j/distributed/proxy/DefaultProxyManagerProducer_ProducerMethod_proxyManager_CFNfymUR1r4llnqJTYRFNNzlrFU_ClientProxy#bean
    ASTORE 1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD io/github/bucket4j/distributed/proxy/DefaultProxyManagerProducer_ProducerMethod_proxyManager_CFNfymUR1r4llnqJTYRFNNzlrFU_ClientProxy#context
    ALOAD 1
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/github/bucket4j/distributed/proxy/DefaultProxyManagerProducer_ProducerMethod_proxyManager_CFNfymUR1r4llnqJTYRFNNzlrFU_ClientProxy#arc$delegate
    ARETURN
    ** label2
...
/bucket4j/distributed/proxy/RemoteBucketBuilder;
    INVOKEINTERFACE io/github/bucket4j/distributed/proxy/ProxyManager#builder
    ARETURN
    ** label2
