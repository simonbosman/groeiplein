// Class: io/netty/channel/EventLoopGroup_kvHDo4zTYet60nqf5jJO26V0iuE_Synthetic_Bean
...
(
    ...
    ** label1
    ...
    PUTFIELD io/netty/channel/EventLoopGroup_kvHDo4zTYet60nqf5jJO26V0iuE_Synthetic_Bean#types
    ICONST_2
    ANEWARRAY java/lang/Object
    ASTORE 6
    ...
    ALOAD 9
    // Field descriptor: Ljava/util/Set;
    PUTFIELD io/netty/channel/EventLoopGroup_kvHDo4zTYet60nqf5jJO26V0iuE_Synthetic_Bean#qualifiers
    ...
    PUTFIELD io/netty/channel/EventLoopGroup_kvHDo4zTYet60nqf5jJO26V0iuE_Synthetic_Bean#params
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/Map;
    GETFIELD io/netty/channel/EventLoopGroup_kvHDo4zTYet60nqf5jJO26V0iuE_Synthetic_Bean#params
    ASTORE 2
    ...
    ** label2
    ...
    INVOKEVIRTUAL io/netty/channel/EventLoopGroup_kvHDo4zTYet60nqf5jJO26V0iuE_Synthetic_Bean#createSynthetic
    ASTORE 9
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label2
    ...
    INVOKESPECIAL io/netty/channel/EventLoopGroup_kvHDo4zTYet60nqf5jJO26V0iuE_Synthetic_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/netty/channel/EventLoopGroup;
    INVOKEVIRTUAL io/netty/channel/EventLoopGroup_kvHDo4zTYet60nqf5jJO26V0iuE_Synthetic_Bean#create
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lio/netty/channel/EventLoopGroup;
    INVOKEVIRTUAL io/netty/channel/EventLoopGroup_kvHDo4zTYet60nqf5jJO26V0iuE_Synthetic_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/netty/channel/EventLoopGroup_kvHDo4zTYet60nqf5jJO26V0iuE_Synthetic_Bean#types
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD io/netty/channel/EventLoopGroup_kvHDo4zTYet60nqf5jJO26V0iuE_Synthetic_Bean#qualifiers
    ARETURN
    ** label2
