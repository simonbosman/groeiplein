// Class: org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_Bean
...
Field proxy : Lorg/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_ClientProxy;
...
// Access: private
Method proxy : Lorg/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_ClientProxy;
(
    // (no arguments)
) {
    ** label1
    ALOAD 0
    // Field descriptor: Lorg/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_ClientProxy;
    GETFIELD org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_Bean#proxy
    ASTORE 1
    ALOAD 1
    IFNULL label2
    ** label3
    ** label4
    GOTO label5
    ** label2
    NEW org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_ClientProxy
    DUP
    LDC (String) "nECz1cu27mu0zyy3urCh_aZpT-U"
    // Method descriptor: (Ljava/lang/String;)V
    INVOKESPECIAL org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_ClientProxy#<init>
    ASTORE 1
    ALOAD 0
    ALOAD 1
    // Field descriptor: Lorg/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_ClientProxy;
    PUTFIELD org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_Bean#proxy
    ** label5
    ALOAD 1
    ARETURN
    ** label6
...
(
    ...
    ** label1
    ...
    PUTFIELD org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_Bean#injectProviderSupplier1
    ICONST_3
    ...
    PUTFIELD org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_Bean#types
    ...
    PUTFIELD org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_Bean#params
    RETURN
    ** label2
...
(
    ...
    ** label2
    ...
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_Bean#injectProviderSupplier1
    ...
    ** label5
    ...
    DUP
    LDC (String) "Error injecting synthetic injection point of bean: nECz1cu27mu0zyy3urCh_aZpT-U"
    ALOAD 9
    ...
    ** label4
    ALOAD 0
    // Field descriptor: Ljava/util/Map;
    GETFIELD org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_Bean#params
    ASTORE 10
    ...
    ** label7
    ...
    INVOKEVIRTUAL org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_Bean#createSynthetic
    ASTORE 16
    ** label8
    GOTO label9
    ** label10
...
(
    ...
    ** label2
    ...
    INVOKESPECIAL org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lorg/hibernate/SessionFactory;
    INVOKEVIRTUAL org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_Bean#create
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Method descriptor: ()Lorg/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_ClientProxy;
    INVOKEVIRTUAL org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_Bean#proxy
    CHECKCAST org/hibernate/SessionFactory
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lorg/hibernate/SessionFactory;
    INVOKEVIRTUAL org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_Bean#types
    ARETURN
    ** label2
