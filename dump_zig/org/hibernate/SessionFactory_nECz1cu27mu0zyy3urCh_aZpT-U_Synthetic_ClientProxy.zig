// Class: org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_ClientProxy
...
(
    ...
    ** label1
    ...
    PUTFIELD org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_ClientProxy#bean
    ALOAD 2
    ...
    PUTFIELD org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_ClientProxy#context
    RETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableBean;
    GETFIELD org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_ClientProxy#bean
    ASTORE 1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_ClientProxy#context
    ALOAD 1
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL org/hibernate/SessionFactory_nECz1cu27mu0zyy3urCh_aZpT-U_Synthetic_ClientProxy#arc$delegate
    ARETURN
    ** label2
...
-U_Synthetic_ClientProxy#arc$delegate
    // Method descriptor: ()Z
    INVOKEINTERFACE org/hibernate/SessionFactory#isOpen
    IRETURN
    ** label2
