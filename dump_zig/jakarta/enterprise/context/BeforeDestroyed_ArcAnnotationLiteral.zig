// Class: jakarta/enterprise/context/BeforeDestroyed_ArcAnnotationLiteral
...
(
    ...
    ** label1
    ...
    PUTFIELD jakarta/enterprise/context/BeforeDestroyed_ArcAnnotationLiteral#value
    RETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/lang/Class;
    GETFIELD jakarta/enterprise/context/BeforeDestroyed_ArcAnnotationLiteral#value
    ARETURN
    ** label2
...
(
    ...
    ** label1
    LDC (Type) Ljakarta/enterprise/context/BeforeDestroyed;
    ARETURN
    ** label2
...
(
    ...
    ** label5
    ALOAD 1
    INSTANCEOF jakarta/enterprise/context/BeforeDestroyed
    IFNE label6
    ** label7
    ICONST_0
    IRETURN
    ...
    ** label9
    ALOAD 1
    CHECKCAST jakarta/enterprise/context/BeforeDestroyed
    ASTORE 2
    ALOAD 0
    // Field descriptor: Ljava/lang/Class;
    GETFIELD jakarta/enterprise/context/BeforeDestroyed_ArcAnnotationLiteral#value
    ...
    INVOKEINTERFACE jakarta/enterprise/context/BeforeDestroyed#value
    ASTORE 4
    ALOAD 3
    ALOAD 4
