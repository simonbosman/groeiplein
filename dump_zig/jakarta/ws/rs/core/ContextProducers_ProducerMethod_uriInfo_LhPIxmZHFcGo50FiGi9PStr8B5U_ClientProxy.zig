// Class: jakarta/ws/rs/core/ContextProducers_ProducerMethod_uriInfo_LhPIxmZHFcGo50FiGi9PStr8B5U_ClientProxy
...
(
    ...
    ** label1
    ...
    PUTFIELD jakarta/ws/rs/core/ContextProducers_ProducerMethod_uriInfo_LhPIxmZHFcGo50FiGi9PStr8B5U_ClientProxy#bean
    ALOAD 2
    ...
    PUTFIELD jakarta/ws/rs/core/ContextProducers_ProducerMethod_uriInfo_LhPIxmZHFcGo50FiGi9PStr8B5U_ClientProxy#context
    RETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableBean;
    GETFIELD jakarta/ws/rs/core/ContextProducers_ProducerMethod_uriInfo_LhPIxmZHFcGo50FiGi9PStr8B5U_ClientProxy#bean
    ASTORE 1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD jakarta/ws/rs/core/ContextProducers_ProducerMethod_uriInfo_LhPIxmZHFcGo50FiGi9PStr8B5U_ClientProxy#context
    ALOAD 1
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL jakarta/ws/rs/core/ContextProducers_ProducerMethod_uriInfo_LhPIxmZHFcGo50FiGi9PStr8B5U_ClientProxy#arc$delegate
    ARETURN
    ** label2
...
50FiGi9PStr8B5U_ClientProxy#arc$delegate
    // Method descriptor: ()Ljakarta/ws/rs/core/UriBuilder;
    INVOKEINTERFACE jakarta/ws/rs/core/UriInfo#getRequestUriBuilder
    ARETURN
    ** label2
