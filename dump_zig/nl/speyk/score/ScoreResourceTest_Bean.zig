// Class: nl/speyk/score/ScoreResourceTest_Bean
...
(
    ...
    ** label1
    ...
    INVOKEINTERFACE java/util/Set#add
    POP
    LDC (Type) Lnl/speyk/score/ScoreResourceTest;
    LDC (String) "jwt"
    ...
    PUTFIELD nl/speyk/score/ScoreResourceTest_Bean#injectProviderSupplier1
    ICONST_2
    ...
    PUTFIELD nl/speyk/score/ScoreResourceTest_Bean#types
    RETURN
    ** label2
...
(
    ...
    ** label1
    LDC (String) "BSY4QwgXUANtMgmeiOeqe3EtnXc"
    ARETURN
    ** label2
...
// Access: private
Method doCreate : Lnl/speyk/score/ScoreResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    NEW nl/speyk/score/ScoreResourceTest
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/score/ScoreResourceTest#<init>
    ASTORE 4
    ** label2
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD nl/speyk/score/ScoreResourceTest_Bean#injectProviderSupplier1
    ...
    PUTFIELD nl/speyk/score/ScoreResourceTest#jwt
    ** label3
    GOTO label4
    ** label5
    ASTORE 6
    ...
    DUP
    LDC (String) "Error injecting java.lang.String nl.speyk.score.ScoreResourceTest.jwt"
    ALOAD 6
...
// Access: public
Method create : Lnl/speyk/score/ScoreResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/score/ScoreResourceTest;
    INVOKESPECIAL nl/speyk/score/ScoreResourceTest_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/score/ScoreResourceTest;
    INVOKEVIRTUAL nl/speyk/score/ScoreResourceTest_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Lnl/speyk/score/ScoreResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/score/ScoreResourceTest;
    INVOKEVIRTUAL nl/speyk/score/ScoreResourceTest_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD nl/speyk/score/ScoreResourceTest_Bean#types
    ARETURN
    ** label2
