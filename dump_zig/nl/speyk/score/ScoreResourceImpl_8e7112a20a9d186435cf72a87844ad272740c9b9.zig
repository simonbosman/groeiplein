// Class: nl/speyk/score/ScoreResourceImpl_8e7112a20a9d186435cf72a87844ad272740c9b9
//     Access =  public synthetic
//     Extends: java/lang/Object
//     Implements:
//         nl/speyk/score/ScoreResource
...
(
    ...
    ** label3
    ...
    INVOKESTATIC nl/speyk/score/Score#findAll
    ASTORE 4
    ALOAD 4
    ALOAD 1
...
(
    ...
    ** label3
    ...
    INVOKESTATIC nl/speyk/score/Score#find
    ASTORE 6
    ALOAD 6
    ALOAD 1
    // Method descriptor: (Lio/quarkus/panache/common/Page;)Lio/quarkus/hibernate/reactive/panache/PanacheQuery;
...
(
    ...
    ** label1
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKESTATIC nl/speyk/score/Score#count
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    INVOKESTATIC nl/speyk/score/Score#findById
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/score/Score#persist
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL nl/speyk/score/Score#$$_hibernate_write_id
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKESTATIC nl/speyk/score/Score#getSession
    ASTORE 4
    ...
    ASTORE 3
    NEW nl/speyk/score/ScoreResourceImpl_8e7112a20a9d186435cf72a87844ad272740c9b9$$function$$1
    DUP
    ALOAD 3
    ALOAD 2
    // Method descriptor: (Lorg/jboss/resteasy/reactive/server/core/ResteasyReactiveRequestContext;Ljava/lang/Object;)V
    INVOKESPECIAL nl/speyk/score/ScoreResourceImpl_8e7112a20a9d186435cf72a87844ad272740c9b9$$function$$1#<init>
    ASTORE 5
    ALOAD 4
    ALOAD 5
    ...
    ASTORE 6
    NEW nl/speyk/score/ScoreResourceImpl_8e7112a20a9d186435cf72a87844ad272740c9b9$$function$$2
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/score/ScoreResourceImpl_8e7112a20a9d186435cf72a87844ad272740c9b9$$function$$2#<init>
    ASTORE 7
    ALOAD 6
...
(
    ...
    ** label1
    ALOAD 1
    // Method descriptor: (Ljava/lang/Object;)Lio/smallrye/mutiny/Uni;
    INVOKESTATIC nl/speyk/score/Score#deleteById
    ARETURN
    ** label2
