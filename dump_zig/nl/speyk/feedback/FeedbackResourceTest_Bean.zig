// Class: nl/speyk/feedback/FeedbackResourceTest_Bean
...
(
    ...
    ** label1
    ...
    INVOKEINTERFACE java/util/Set#add
    POP
    LDC (Type) Lnl/speyk/feedback/FeedbackResourceTest;
    LDC (String) "jwt"
    ...
    PUTFIELD nl/speyk/feedback/FeedbackResourceTest_Bean#injectProviderSupplier1
    ICONST_2
    ...
    PUTFIELD nl/speyk/feedback/FeedbackResourceTest_Bean#types
    RETURN
    ** label2
...
(
    ...
    ** label1
    LDC (String) "bRZL88_VwgHA6UyzY3vMflhqYNg"
    ARETURN
    ** label2
...
// Access: private
Method doCreate : Lnl/speyk/feedback/FeedbackResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    NEW nl/speyk/feedback/FeedbackResourceTest
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/feedback/FeedbackResourceTest#<init>
    ASTORE 4
    ** label2
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD nl/speyk/feedback/FeedbackResourceTest_Bean#injectProviderSupplier1
    ...
    PUTFIELD nl/speyk/feedback/FeedbackResourceTest#jwt
    ** label3
    GOTO label4
    ** label5
    ASTORE 6
    ...
    DUP
    LDC (String) "Error injecting java.lang.String nl.speyk.feedback.FeedbackResourceTest.jwt"
    ALOAD 6
...
// Access: public
Method create : Lnl/speyk/feedback/FeedbackResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/feedback/FeedbackResourceTest;
    INVOKESPECIAL nl/speyk/feedback/FeedbackResourceTest_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/feedback/FeedbackResourceTest;
    INVOKEVIRTUAL nl/speyk/feedback/FeedbackResourceTest_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Lnl/speyk/feedback/FeedbackResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/feedback/FeedbackResourceTest;
    INVOKEVIRTUAL nl/speyk/feedback/FeedbackResourceTest_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD nl/speyk/feedback/FeedbackResourceTest_Bean#types
    ARETURN
    ** label2
