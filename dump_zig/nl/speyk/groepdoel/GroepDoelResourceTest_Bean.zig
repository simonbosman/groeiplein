// Class: nl/speyk/groepdoel/GroepDoelResourceTest_Bean
...
(
    ...
    ** label1
    ...
    INVOKEINTERFACE java/util/Set#add
    POP
    LDC (Type) Lnl/speyk/groepdoel/GroepDoelResourceTest;
    LDC (String) "jwt"
    ...
    PUTFIELD nl/speyk/groepdoel/GroepDoelResourceTest_Bean#injectProviderSupplier1
    ICONST_2
    ...
    PUTFIELD nl/speyk/groepdoel/GroepDoelResourceTest_Bean#types
    RETURN
    ** label2
...
(
    ...
    ** label1
    LDC (String) "S0b_2dF_F3SlIclWsNgL81ukNVo"
    ARETURN
    ** label2
...
// Access: private
Method doCreate : Lnl/speyk/groepdoel/GroepDoelResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    NEW nl/speyk/groepdoel/GroepDoelResourceTest
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/groepdoel/GroepDoelResourceTest#<init>
    ASTORE 4
    ** label2
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD nl/speyk/groepdoel/GroepDoelResourceTest_Bean#injectProviderSupplier1
    ...
    PUTFIELD nl/speyk/groepdoel/GroepDoelResourceTest#jwt
    ** label3
    GOTO label4
    ** label5
    ASTORE 6
    ...
    DUP
    LDC (String) "Error injecting java.lang.String nl.speyk.groepdoel.GroepDoelResourceTest.jwt"
    ALOAD 6
...
// Access: public
Method create : Lnl/speyk/groepdoel/GroepDoelResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/groepdoel/GroepDoelResourceTest;
    INVOKESPECIAL nl/speyk/groepdoel/GroepDoelResourceTest_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/groepdoel/GroepDoelResourceTest;
    INVOKEVIRTUAL nl/speyk/groepdoel/GroepDoelResourceTest_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Lnl/speyk/groepdoel/GroepDoelResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/groepdoel/GroepDoelResourceTest;
    INVOKEVIRTUAL nl/speyk/groepdoel/GroepDoelResourceTest_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD nl/speyk/groepdoel/GroepDoelResourceTest_Bean#types
    ARETURN
    ** label2
