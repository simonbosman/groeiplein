// Class: nl/speyk/groepdoel/GroepDoelResourceImpl_b9c708cff02e35f28663d105c1b88d98fd58c2d4
//     Access =  public synthetic
//     Extends: java/lang/Object
//     Implements:
//         nl/speyk/groepdoel/GroepDoelResource
...
(
    ...
    ** label3
    ...
    INVOKESTATIC nl/speyk/groepdoel/GroepDoel#findAll
    ASTORE 4
    ALOAD 4
    ALOAD 1
...
(
    ...
    ** label3
    ...
    INVOKESTATIC nl/speyk/groepdoel/GroepDoel#find
    ASTORE 6
    ALOAD 6
    ALOAD 1
    // Method descriptor: (Lio/quarkus/panache/common/Page;)Lio/quarkus/hibernate/reactive/panache/PanacheQuery;
...
(
    ...
    ** label1
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKESTATIC nl/speyk/groepdoel/GroepDoel#count
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    INVOKESTATIC nl/speyk/groepdoel/GroepDoel#findById
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/groepdoel/GroepDoel#persist
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL nl/speyk/groepdoel/GroepDoel#$$_hibernate_write_id
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKESTATIC nl/speyk/groepdoel/GroepDoel#getSession
    ASTORE 4
    ...
    ASTORE 3
    NEW nl/speyk/groepdoel/GroepDoelResourceImpl_b9c708cff02e35f28663d105c1b88d98fd58c2d4$$function$$1
    DUP
    ALOAD 3
    ALOAD 2
    // Method descriptor: (Lorg/jboss/resteasy/reactive/server/core/ResteasyReactiveRequestContext;Ljava/lang/Object;)V
    INVOKESPECIAL nl/speyk/groepdoel/GroepDoelResourceImpl_b9c708cff02e35f28663d105c1b88d98fd58c2d4$$function$$1#<init>
    ASTORE 5
    ALOAD 4
    ALOAD 5
    ...
    ASTORE 6
    NEW nl/speyk/groepdoel/GroepDoelResourceImpl_b9c708cff02e35f28663d105c1b88d98fd58c2d4$$function$$2
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/groepdoel/GroepDoelResourceImpl_b9c708cff02e35f28663d105c1b88d98fd58c2d4$$function$$2#<init>
    ASTORE 7
    ALOAD 6
...
(
    ...
    ** label1
    ALOAD 1
    // Method descriptor: (Ljava/lang/Object;)Lio/smallrye/mutiny/Uni;
    INVOKESTATIC nl/speyk/groepdoel/GroepDoel#deleteById
    ARETURN
    ** label2
