// Class: nl/speyk/leerling/LeerlingResourceTest_Bean
...
(
    ...
    ** label1
    ...
    INVOKEINTERFACE java/util/Set#add
    POP
    LDC (Type) Lnl/speyk/leerling/LeerlingResourceTest;
    LDC (String) "jwt"
    ...
    PUTFIELD nl/speyk/leerling/LeerlingResourceTest_Bean#injectProviderSupplier1
    ICONST_2
    ...
    PUTFIELD nl/speyk/leerling/LeerlingResourceTest_Bean#types
    RETURN
    ** label2
...
(
    ...
    ** label1
    LDC (String) "S0CCNWgPKPwxrubU7cCxvgevoyM"
    ARETURN
    ** label2
...
// Access: private
Method doCreate : Lnl/speyk/leerling/LeerlingResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    NEW nl/speyk/leerling/LeerlingResourceTest
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/leerling/LeerlingResourceTest#<init>
    ASTORE 4
    ** label2
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD nl/speyk/leerling/LeerlingResourceTest_Bean#injectProviderSupplier1
    ...
    PUTFIELD nl/speyk/leerling/LeerlingResourceTest#jwt
    ** label3
    GOTO label4
    ** label5
    ASTORE 6
    ...
    DUP
    LDC (String) "Error injecting java.lang.String nl.speyk.leerling.LeerlingResourceTest.jwt"
    ALOAD 6
...
// Access: public
Method create : Lnl/speyk/leerling/LeerlingResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/leerling/LeerlingResourceTest;
    INVOKESPECIAL nl/speyk/leerling/LeerlingResourceTest_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/leerling/LeerlingResourceTest;
    INVOKEVIRTUAL nl/speyk/leerling/LeerlingResourceTest_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Lnl/speyk/leerling/LeerlingResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/leerling/LeerlingResourceTest;
    INVOKEVIRTUAL nl/speyk/leerling/LeerlingResourceTest_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD nl/speyk/leerling/LeerlingResourceTest_Bean#types
    ARETURN
    ** label2
