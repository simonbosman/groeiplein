// Class: nl/speyk/leerling/LeerlingCustomResource_Subclass
//     Access =  public synthetic
//     Extends: nl/speyk/leerling/LeerlingCustomResource
//     Implements:
...
(
    ...
    ** label1
    ALOAD 0
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/leerling/LeerlingCustomResource#<init>
    ALOAD 1
    ...
    INVOKEVIRTUAL nl/speyk/leerling/LeerlingCustomResource_Subclass#arc$initMetadata0
    RETURN
    ** label2
...
// Access: public
Method findLeerlingByUuid$$superforward : Lio/smallrye/mutiny/Uni;
(
    ...
    ** label1
    ...
    INVOKESPECIAL nl/speyk/leerling/LeerlingCustomResource#findLeerlingByUuid
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ICONST_1
    // Field descriptor: Z
    PUTFIELD nl/speyk/leerling/LeerlingCustomResource_Subclass#arc$constructed
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    INVOKEINTERFACE java/util/Map#get
    ASTORE 6
    NEW nl/speyk/leerling/LeerlingCustomResource_Subclass$$function$$1
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/leerling/LeerlingCustomResource_Subclass$$function$$1#<init>
    ASTORE 7
    ...
    PUTFIELD nl/speyk/leerling/LeerlingCustomResource_Subclass#arc$1
    RETURN
    ** label2
...
// Access: public
Method findLeerlingByUuid : Lio/smallrye/mutiny/Uni;
(
    arg 1 = Ljava/util/UUID;
) {
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Z
    GETFIELD nl/speyk/leerling/LeerlingCustomResource_Subclass#arc$constructed
    IFEQ label2
    ** label3
    ** label4
    GOTO label5
    ** label2
    ...
    ALOAD 1
    // Method descriptor: (Ljava/util/UUID;)Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/leerling/LeerlingCustomResource_Subclass#findLeerlingByUuid$$superforward
    ARETURN
    ** label5
    ** label6
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/impl/InterceptedMethodMetadata;
    GETFIELD nl/speyk/leerling/LeerlingCustomResource_Subclass#arc$1
    ASTORE 3
    ALOAD 0
    ALOAD 2
    ALOAD 3
