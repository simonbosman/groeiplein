// Class: nl/speyk/doel/DoelCustomResource_Bean
...
(
    ...
    ** label1
    ...
    PUTFIELD nl/speyk/doel/DoelCustomResource_Bean#injectProviderSupplier1
    ALOAD 0
    ALOAD 2
    // Field descriptor: Ljava/util/function/Supplier;
    PUTFIELD nl/speyk/doel/DoelCustomResource_Bean#interceptorProviderSupplier2
    ALOAD 0
    ALOAD 3
    // Field descriptor: Ljava/util/function/Supplier;
    PUTFIELD nl/speyk/doel/DoelCustomResource_Bean#interceptorProviderSupplier3
    ICONST_2
    ...
    PUTFIELD nl/speyk/doel/DoelCustomResource_Bean#types
    RETURN
    ** label2
...
// Access: private
Method doCreate : Lnl/speyk/doel/DoelCustomResource;
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD nl/speyk/doel/DoelCustomResource_Bean#interceptorProviderSupplier2
    // Method descriptor: ()Ljava/lang/Object;
    INVOKEINTERFACE java/util/function/Supplier#get
    ASTORE 2
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD nl/speyk/doel/DoelCustomResource_Bean#interceptorProviderSupplier3
    // Method descriptor: ()Ljava/lang/Object;
    INVOKEINTERFACE java/util/function/Supplier#get
    ASTORE 3
    NEW nl/speyk/doel/DoelCustomResource_Subclass
    DUP
    ALOAD 1
    ALOAD 2
    ...
    INVOKESPECIAL nl/speyk/doel/DoelCustomResource_Subclass#<init>
    CHECKCAST nl/speyk/doel/DoelCustomResource
    ASTORE 6
    ** label2
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD nl/speyk/doel/DoelCustomResource_Bean#injectProviderSupplier1
    // Method descriptor: ()Ljava/lang/Object;
    INVOKEINTERFACE java/util/function/Supplier#get
    ASTORE 4
    ALOAD 4
    ...
    // Field descriptor: Lnl/speyk/doel/DoelService;
    PUTFIELD nl/speyk/doel/DoelCustomResource#doelService
    ** label3
    GOTO label4
    ** label5
    ASTORE 8
    ...
    DUP
    LDC (String) "Error injecting nl.speyk.doel.DoelService nl.speyk.doel.DoelCustomResource.doelService"
    ALOAD 8
    ...
    ** label4
    ALOAD 6
    CHECKCAST nl/speyk/doel/DoelCustomResource_Subclass
    // Method descriptor: ()V
    INVOKEVIRTUAL nl/speyk/doel/DoelCustomResource_Subclass#arc$markConstructed
    ALOAD 6
    ARETURN
    ** label7
...
// Access: public
Method create : Lnl/speyk/doel/DoelCustomResource;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/doel/DoelCustomResource;
    INVOKESPECIAL nl/speyk/doel/DoelCustomResource_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/doel/DoelCustomResource;
    INVOKEVIRTUAL nl/speyk/doel/DoelCustomResource_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Lnl/speyk/doel/DoelCustomResource;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/doel/DoelCustomResource;
    INVOKEVIRTUAL nl/speyk/doel/DoelCustomResource_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD nl/speyk/doel/DoelCustomResource_Bean#types
    ARETURN
    ** label2
