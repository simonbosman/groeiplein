// Class: nl/speyk/doel/DoelService_Subclass
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL nl/speyk/doel/DoelService_Subclass#arc$initMetadata0
    RETURN
    ** label2
...
// Access: public
Method getDoelenByNiveauId$$superforward : Lio/smallrye/mutiny/Uni;
(
...
// Access: public
Method getDoelenByVakleergebiedId$$superforward : Lio/smallrye/mutiny/Uni;
(
    arg 1 = Ljava/lang/Long;
) {
    ** label1
...
// Access: public
Method getDoelenZonderGroep$$superforward : Lio/smallrye/mutiny/Uni;
(
    // (no arguments)
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ICONST_1
    // Field descriptor: Z
    PUTFIELD nl/speyk/doel/DoelService_Subclass#arc$constructed
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    INVOKEINTERFACE java/util/Map#get
    ASTORE 6
    NEW nl/speyk/doel/DoelService_Subclass$$function$$1
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/doel/DoelService_Subclass$$function$$1#<init>
    ASTORE 7
    ...
    PUTFIELD nl/speyk/doel/DoelService_Subclass#arc$1
    ICONST_1
    ANEWARRAY java/lang/Class
    ASTORE 9
    ALOAD 9
    ...
    INVOKESTATIC io/quarkus/arc/impl/Reflections#findMethod
    ASTORE 10
    NEW nl/speyk/doel/DoelService_Subclass$$function$$2
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/doel/DoelService_Subclass$$function$$2#<init>
    ASTORE 11
    NEW io/quarkus/arc/impl/InterceptedMethodMetadata
    DUP
    ALOAD 4
    ...
    ALOAD 12
    // Field descriptor: Lio/quarkus/arc/impl/InterceptedMethodMetadata;
    PUTFIELD nl/speyk/doel/DoelService_Subclass#arc$2
    // Field descriptor: [Ljava/lang/Class;
    ...
    INVOKESTATIC io/quarkus/arc/impl/Reflections#findMethod
    ASTORE 14
    NEW nl/speyk/doel/DoelService_Subclass$$function$$3
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/doel/DoelService_Subclass$$function$$3#<init>
    ASTORE 15
    NEW io/quarkus/arc/impl/InterceptedMethodMetadata
    DUP
    ALOAD 4
    ...
    ALOAD 16
    // Field descriptor: Lio/quarkus/arc/impl/InterceptedMethodMetadata;
    PUTFIELD nl/speyk/doel/DoelService_Subclass#arc$3
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 0
    // Field descriptor: Z
    GETFIELD nl/speyk/doel/DoelService_Subclass#arc$constructed
    IFEQ label2
    ** label3
    ** label4
    GOTO label5
    ** label2
    ...
    ALOAD 1
    // Method descriptor: (Ljava/lang/Long;)Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/doel/DoelService_Subclass#getDoelenByNiveauId$$superforward
    ARETURN
    ** label5
    ** label6
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/impl/InterceptedMethodMetadata;
    GETFIELD nl/speyk/doel/DoelService_Subclass#arc$1
    ASTORE 3
    ALOAD 0
    ALOAD 2
    ALOAD 3
...
(
    ...
    ** label2
    ...
    ALOAD 1
    // Method descriptor: (Ljava/lang/Long;)Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/doel/DoelService_Subclass#getDoelenByVakleergebiedId$$superforward
    ARETURN
    ** label5
    ** label6
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/impl/InterceptedMethodMetadata;
    GETFIELD nl/speyk/doel/DoelService_Subclass#arc$2
    ASTORE 3
    ALOAD 0
    ALOAD 2
    ALOAD 3
...
(
    ...
    ** label2
    ALOAD 0
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/doel/DoelService_Subclass#getDoelenZonderGroep$$superforward
    ARETURN
    ** label5
    ** label6
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/impl/InterceptedMethodMetadata;
    GETFIELD nl/speyk/doel/DoelService_Subclass#arc$3
    ASTORE 1
    ALOAD 0
    ACONST_NULL
    ALOAD 1
