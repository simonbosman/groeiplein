// Class: nl/speyk/doel/DoelResourceTest_Bean
...
(
    ...
    ** label1
    ...
    INVOKEINTERFACE java/util/Set#add
    POP
    LDC (Type) Lnl/speyk/doel/DoelResourceTest;
    LDC (String) "jwt"
    ...
    PUTFIELD nl/speyk/doel/DoelResourceTest_Bean#injectProviderSupplier1
    ICONST_2
    ...
    PUTFIELD nl/speyk/doel/DoelResourceTest_Bean#types
    RETURN
    ** label2
...
(
    ...
    ** label1
    LDC (String) "-aaoF5CrMf4SbXPnsDsiTBoMw78"
    ARETURN
    ** label2
...
// Access: private
Method doCreate : Lnl/speyk/doel/DoelResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    NEW nl/speyk/doel/DoelResourceTest
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/doel/DoelResourceTest#<init>
    ASTORE 4
    ** label2
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD nl/speyk/doel/DoelResourceTest_Bean#injectProviderSupplier1
    ...
    PUTFIELD nl/speyk/doel/DoelResourceTest#jwt
    ** label3
    GOTO label4
    ** label5
    ASTORE 6
    ...
    DUP
    LDC (String) "Error injecting java.lang.String nl.speyk.doel.DoelResourceTest.jwt"
    ALOAD 6
...
// Access: public
Method create : Lnl/speyk/doel/DoelResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/doel/DoelResourceTest;
    INVOKESPECIAL nl/speyk/doel/DoelResourceTest_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/doel/DoelResourceTest;
    INVOKEVIRTUAL nl/speyk/doel/DoelResourceTest_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Lnl/speyk/doel/DoelResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/doel/DoelResourceTest;
    INVOKEVIRTUAL nl/speyk/doel/DoelResourceTest_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD nl/speyk/doel/DoelResourceTest_Bean#types
    ARETURN
    ** label2
