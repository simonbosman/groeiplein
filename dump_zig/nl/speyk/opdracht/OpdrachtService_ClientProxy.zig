// Class: nl/speyk/opdracht/OpdrachtService_ClientProxy
...
(
    ...
    ** label1
    ...
    PUTFIELD nl/speyk/opdracht/OpdrachtService_ClientProxy#bean
    ALOAD 2
    ...
    PUTFIELD nl/speyk/opdracht/OpdrachtService_ClientProxy#context
    RETURN
    ** label2
...
// Access: private
Method arc$delegate : Lnl/speyk/opdracht/OpdrachtService;
(
    // (no arguments)
) {
    ** label1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableBean;
    GETFIELD nl/speyk/opdracht/OpdrachtService_ClientProxy#bean
    ASTORE 1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD nl/speyk/opdracht/OpdrachtService_ClientProxy#context
    ALOAD 1
...
(
    ...
    ** label1
    ALOAD 0
    // Method descriptor: ()Lnl/speyk/opdracht/OpdrachtService;
    INVOKEVIRTUAL nl/speyk/opdracht/OpdrachtService_ClientProxy#arc$delegate
    ARETURN
    ** label2
...
(
    ...
    ** label2
    ...
    INVOKESPECIAL nl/speyk/opdracht/OpdrachtService#toString
    ARETURN
    ** label5
    ALOAD 0
    // Method descriptor: ()Lnl/speyk/opdracht/OpdrachtService;
...
(
    ...
    ** label5
    ...
    INVOKEVIRTUAL nl/speyk/opdracht/OpdrachtService_ClientProxy#arc$delegate
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/opdracht/OpdrachtService#getOpdrachtenZonderGroep
    ARETURN
    ** label6
    
}

pdracht/OpdrachtService_ClientProxy#arc$delegate
    // Method descriptor: ()Ljava/lang/String;
    INVOKEVIRTUAL java/lang/Object#toString
    ARETURN
    ** label6
