// Class: nl/speyk/opdracht/OpdrachtService_Subclass
//     Access =  public synthetic
//     Extends: nl/speyk/opdracht/OpdrachtService
//     Implements:
...
(
    ...
    ** label1
    ALOAD 0
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/opdracht/OpdrachtService#<init>
    ALOAD 1
    ...
    INVOKEVIRTUAL nl/speyk/opdracht/OpdrachtService_Subclass#arc$initMetadata0
    RETURN
    ** label2
...
// Access: public
Method getOpdrachtenZonderGroep$$superforward : Lio/smallrye/mutiny/Uni;
(
    // (no arguments)
) {
    ** label1
    ...
    INVOKESPECIAL nl/speyk/opdracht/OpdrachtService#getOpdrachtenZonderGroep
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ICONST_1
    // Field descriptor: Z
    PUTFIELD nl/speyk/opdracht/OpdrachtService_Subclass#arc$constructed
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    INVOKEINTERFACE java/util/Map#get
    ASTORE 6
    NEW nl/speyk/opdracht/OpdrachtService_Subclass$$function$$1
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/opdracht/OpdrachtService_Subclass$$function$$1#<init>
    ASTORE 7
    ...
    PUTFIELD nl/speyk/opdracht/OpdrachtService_Subclass#arc$1
    RETURN
    ** label2
...
// Access: public
Method getOpdrachtenZonderGroep : Lio/smallrye/mutiny/Uni;
(
    // (no arguments)
) {
    ** label1
    ALOAD 0
    // Field descriptor: Z
    GETFIELD nl/speyk/opdracht/OpdrachtService_Subclass#arc$constructed
    IFEQ label2
    ** label3
    ** label4
    GOTO label5
    ** label2
    ALOAD 0
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/opdracht/OpdrachtService_Subclass#getOpdrachtenZonderGroep$$superforward
    ARETURN
    ** label5
    ** label6
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/impl/InterceptedMethodMetadata;
    GETFIELD nl/speyk/opdracht/OpdrachtService_Subclass#arc$1
    ASTORE 1
    ALOAD 0
    ACONST_NULL
    ALOAD 1
