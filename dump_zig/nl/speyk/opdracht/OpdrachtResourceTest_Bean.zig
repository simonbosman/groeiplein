// Class: nl/speyk/opdracht/OpdrachtResourceTest_Bean
...
(
    ...
    ** label1
    ...
    INVOKEINTERFACE java/util/Set#add
    POP
    LDC (Type) Lnl/speyk/opdracht/OpdrachtResourceTest;
    LDC (String) "jwt"
    ...
    PUTFIELD nl/speyk/opdracht/OpdrachtResourceTest_Bean#injectProviderSupplier1
    ICONST_2
    ...
    PUTFIELD nl/speyk/opdracht/OpdrachtResourceTest_Bean#types
    RETURN
    ** label2
...
(
    ...
    ** label1
    LDC (String) "T3CP0K84DwRGfneiCfEypL9yXOI"
    ARETURN
    ** label2
...
// Access: private
Method doCreate : Lnl/speyk/opdracht/OpdrachtResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    NEW nl/speyk/opdracht/OpdrachtResourceTest
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/opdracht/OpdrachtResourceTest#<init>
    ASTORE 4
    ** label2
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD nl/speyk/opdracht/OpdrachtResourceTest_Bean#injectProviderSupplier1
    ...
    PUTFIELD nl/speyk/opdracht/OpdrachtResourceTest#jwt
    ** label3
    GOTO label4
    ** label5
    ASTORE 6
    ...
    DUP
    LDC (String) "Error injecting java.lang.String nl.speyk.opdracht.OpdrachtResourceTest.jwt"
    ALOAD 6
...
// Access: public
Method create : Lnl/speyk/opdracht/OpdrachtResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/opdracht/OpdrachtResourceTest;
    INVOKESPECIAL nl/speyk/opdracht/OpdrachtResourceTest_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/opdracht/OpdrachtResourceTest;
    INVOKEVIRTUAL nl/speyk/opdracht/OpdrachtResourceTest_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Lnl/speyk/opdracht/OpdrachtResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/opdracht/OpdrachtResourceTest;
    INVOKEVIRTUAL nl/speyk/opdracht/OpdrachtResourceTest_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD nl/speyk/opdracht/OpdrachtResourceTest_Bean#types
    ARETURN
    ** label2
