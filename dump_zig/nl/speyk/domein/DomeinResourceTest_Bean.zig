// Class: nl/speyk/domein/DomeinResourceTest_Bean
...
(
    ...
    ** label1
    ...
    INVOKEINTERFACE java/util/Set#add
    POP
    LDC (Type) Lnl/speyk/domein/DomeinResourceTest;
    LDC (String) "jwt"
    ...
    PUTFIELD nl/speyk/domein/DomeinResourceTest_Bean#injectProviderSupplier1
    ICONST_2
    ...
    PUTFIELD nl/speyk/domein/DomeinResourceTest_Bean#types
    RETURN
    ** label2
...
(
    ...
    ** label1
    LDC (String) "kvYct5nQL2eSz65KiAOdpveVlww"
    ARETURN
    ** label2
...
// Access: private
Method doCreate : Lnl/speyk/domein/DomeinResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    NEW nl/speyk/domein/DomeinResourceTest
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/domein/DomeinResourceTest#<init>
    ASTORE 4
    ** label2
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD nl/speyk/domein/DomeinResourceTest_Bean#injectProviderSupplier1
    ...
    PUTFIELD nl/speyk/domein/DomeinResourceTest#jwt
    ** label3
    GOTO label4
    ** label5
    ASTORE 6
    ...
    DUP
    LDC (String) "Error injecting java.lang.String nl.speyk.domein.DomeinResourceTest.jwt"
    ALOAD 6
...
// Access: public
Method create : Lnl/speyk/domein/DomeinResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/domein/DomeinResourceTest;
    INVOKESPECIAL nl/speyk/domein/DomeinResourceTest_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/domein/DomeinResourceTest;
    INVOKEVIRTUAL nl/speyk/domein/DomeinResourceTest_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Lnl/speyk/domein/DomeinResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/domein/DomeinResourceTest;
    INVOKEVIRTUAL nl/speyk/domein/DomeinResourceTest_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD nl/speyk/domein/DomeinResourceTest_Bean#types
    ARETURN
    ** label2
