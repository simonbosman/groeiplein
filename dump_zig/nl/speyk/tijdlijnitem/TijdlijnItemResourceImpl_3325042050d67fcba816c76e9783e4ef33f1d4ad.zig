// Class: nl/speyk/tijdlijnitem/TijdlijnItemResourceImpl_3325042050d67fcba816c76e9783e4ef33f1d4ad
//     Access =  public synthetic
//     Extends: java/lang/Object
//     Implements:
//         nl/speyk/tijdlijnitem/TijdlijnItemResource
...
(
    ...
    ** label3
    ...
    INVOKESTATIC nl/speyk/tijdlijnitem/TijdlijnItem#findAll
    ASTORE 4
    ALOAD 4
    ALOAD 1
...
(
    ...
    ** label3
    ...
    INVOKESTATIC nl/speyk/tijdlijnitem/TijdlijnItem#find
    ASTORE 6
    ALOAD 6
    ALOAD 1
    // Method descriptor: (Lio/quarkus/panache/common/Page;)Lio/quarkus/hibernate/reactive/panache/PanacheQuery;
...
(
    ...
    ** label1
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKESTATIC nl/speyk/tijdlijnitem/TijdlijnItem#count
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    INVOKESTATIC nl/speyk/tijdlijnitem/TijdlijnItem#findById
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/tijdlijnitem/TijdlijnItem#persist
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL nl/speyk/tijdlijnitem/TijdlijnItem#$$_hibernate_write_id
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKESTATIC nl/speyk/tijdlijnitem/TijdlijnItem#getSession
    ASTORE 4
    ...
    ASTORE 3
    NEW nl/speyk/tijdlijnitem/TijdlijnItemResourceImpl_3325042050d67fcba816c76e9783e4ef33f1d4ad$$function$$1
    DUP
    ALOAD 3
    ALOAD 2
    // Method descriptor: (Lorg/jboss/resteasy/reactive/server/core/ResteasyReactiveRequestContext;Ljava/lang/Object;)V
    INVOKESPECIAL nl/speyk/tijdlijnitem/TijdlijnItemResourceImpl_3325042050d67fcba816c76e9783e4ef33f1d4ad$$function$$1#<init>
    ASTORE 5
    ALOAD 4
    ALOAD 5
    ...
    ASTORE 6
    NEW nl/speyk/tijdlijnitem/TijdlijnItemResourceImpl_3325042050d67fcba816c76e9783e4ef33f1d4ad$$function$$2
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/tijdlijnitem/TijdlijnItemResourceImpl_3325042050d67fcba816c76e9783e4ef33f1d4ad$$function$$2#<init>
    ASTORE 7
    ALOAD 6
...
(
    ...
    ** label1
    ALOAD 1
    // Method descriptor: (Ljava/lang/Object;)Lio/smallrye/mutiny/Uni;
    INVOKESTATIC nl/speyk/tijdlijnitem/TijdlijnItem#deleteById
    ARETURN
    ** label2
