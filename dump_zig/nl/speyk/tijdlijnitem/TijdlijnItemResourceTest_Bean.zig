// Class: nl/speyk/tijdlijnitem/TijdlijnItemResourceTest_Bean
...
(
    ...
    ** label1
    ...
    INVOKEINTERFACE java/util/Set#add
    POP
    LDC (Type) Lnl/speyk/tijdlijnitem/TijdlijnItemResourceTest;
    LDC (String) "jwt"
    ...
    PUTFIELD nl/speyk/tijdlijnitem/TijdlijnItemResourceTest_Bean#injectProviderSupplier1
    ICONST_2
    ...
    PUTFIELD nl/speyk/tijdlijnitem/TijdlijnItemResourceTest_Bean#types
    RETURN
    ** label2
...
(
    ...
    ** label1
    LDC (String) "z_Bj4h9va7Kddi1GCU0dPq2_hPM"
    ARETURN
    ** label2
...
// Access: private
Method doCreate : Lnl/speyk/tijdlijnitem/TijdlijnItemResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    NEW nl/speyk/tijdlijnitem/TijdlijnItemResourceTest
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/tijdlijnitem/TijdlijnItemResourceTest#<init>
    ASTORE 4
    ** label2
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD nl/speyk/tijdlijnitem/TijdlijnItemResourceTest_Bean#injectProviderSupplier1
    ...
    PUTFIELD nl/speyk/tijdlijnitem/TijdlijnItemResourceTest#jwt
    ** label3
    GOTO label4
    ** label5
    ASTORE 6
    ...
    DUP
    LDC (String) "Error injecting java.lang.String nl.speyk.tijdlijnitem.TijdlijnItemResourceTest.jwt"
    ALOAD 6
...
// Access: public
Method create : Lnl/speyk/tijdlijnitem/TijdlijnItemResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/tijdlijnitem/TijdlijnItemResourceTest;
    INVOKESPECIAL nl/speyk/tijdlijnitem/TijdlijnItemResourceTest_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/tijdlijnitem/TijdlijnItemResourceTest;
    INVOKEVIRTUAL nl/speyk/tijdlijnitem/TijdlijnItemResourceTest_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Lnl/speyk/tijdlijnitem/TijdlijnItemResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/tijdlijnitem/TijdlijnItemResourceTest;
    INVOKEVIRTUAL nl/speyk/tijdlijnitem/TijdlijnItemResourceTest_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD nl/speyk/tijdlijnitem/TijdlijnItemResourceTest_Bean#types
    ARETURN
    ** label2
