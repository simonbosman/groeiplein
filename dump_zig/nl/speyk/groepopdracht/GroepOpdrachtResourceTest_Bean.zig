// Class: nl/speyk/groepopdracht/GroepOpdrachtResourceTest_Bean
...
(
    ...
    ** label1
    ...
    INVOKEINTERFACE java/util/Set#add
    POP
    LDC (Type) Lnl/speyk/groepopdracht/GroepOpdrachtResourceTest;
    LDC (String) "jwt"
    ...
    PUTFIELD nl/speyk/groepopdracht/GroepOpdrachtResourceTest_Bean#injectProviderSupplier1
    ICONST_2
    ...
    PUTFIELD nl/speyk/groepopdracht/GroepOpdrachtResourceTest_Bean#types
    RETURN
    ** label2
...
(
    ...
    ** label1
    LDC (String) "JrcphuUFh89ejpZx_7tU9vTPC2k"
    ARETURN
    ** label2
...
// Access: private
Method doCreate : Lnl/speyk/groepopdracht/GroepOpdrachtResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    NEW nl/speyk/groepopdracht/GroepOpdrachtResourceTest
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/groepopdracht/GroepOpdrachtResourceTest#<init>
    ASTORE 4
    ** label2
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD nl/speyk/groepopdracht/GroepOpdrachtResourceTest_Bean#injectProviderSupplier1
    ...
    PUTFIELD nl/speyk/groepopdracht/GroepOpdrachtResourceTest#jwt
    ** label3
    GOTO label4
    ** label5
    ASTORE 6
    ...
    DUP
    LDC (String) "Error injecting java.lang.String nl.speyk.groepopdracht.GroepOpdrachtResourceTest.jwt"
    ALOAD 6
...
// Access: public
Method create : Lnl/speyk/groepopdracht/GroepOpdrachtResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/groepopdracht/GroepOpdrachtResourceTest;
    INVOKESPECIAL nl/speyk/groepopdracht/GroepOpdrachtResourceTest_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/groepopdracht/GroepOpdrachtResourceTest;
    INVOKEVIRTUAL nl/speyk/groepopdracht/GroepOpdrachtResourceTest_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Lnl/speyk/groepopdracht/GroepOpdrachtResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/groepopdracht/GroepOpdrachtResourceTest;
    INVOKEVIRTUAL nl/speyk/groepopdracht/GroepOpdrachtResourceTest_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD nl/speyk/groepopdracht/GroepOpdrachtResourceTest_Bean#types
    ARETURN
    ** label2
