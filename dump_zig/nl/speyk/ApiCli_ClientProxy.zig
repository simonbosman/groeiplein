// Class: nl/speyk/ApiCli_ClientProxy
//     Access =  public synthetic
//     Extends: nl/speyk/ApiCli
//     Implements:
...
(
    ...
    ** label1
    ...
    PUTFIELD nl/speyk/ApiCli_ClientProxy#bean
    ALOAD 2
    ...
    PUTFIELD nl/speyk/ApiCli_ClientProxy#context
    RETURN
    ** label2
...
// Access: private
Method arc$delegate : Lnl/speyk/ApiCli;
(
    // (no arguments)
) {
    ** label1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableBean;
    GETFIELD nl/speyk/ApiCli_ClientProxy#bean
    ASTORE 1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD nl/speyk/ApiCli_ClientProxy#context
    ALOAD 1
...
(
    ...
    ** label1
    ALOAD 0
    // Method descriptor: ()Lnl/speyk/ApiCli;
    INVOKEVIRTUAL nl/speyk/ApiCli_ClientProxy#arc$delegate
    ARETURN
    ** label2
...
(
    ...
    ** label2
    ...
    INVOKESPECIAL nl/speyk/ApiCli#run
    IRETURN
    ** label5
    ALOAD 0
    // Method descriptor: ()Lnl/speyk/ApiCli;
    ...
    ALOAD 1
    // Method descriptor: ([Ljava/lang/String;)I
    INVOKEVIRTUAL nl/speyk/ApiCli#run
    IRETURN
    ** label6
...
(
    ...
    ** label2
    ...
    INVOKESPECIAL nl/speyk/ApiCli#toString
    ARETURN
    ** label5
    ALOAD 0
    // Method descriptor: ()Lnl/speyk/ApiCli;
...
OKEVIRTUAL nl/speyk/ApiCli_ClientProxy#arc$delegate
    ALOAD 1
    // Method descriptor: ([Ljava/lang/String;)I
    INVOKEVIRTUAL nl/speyk/ApiCli#run
    IRETURN
