// Class: nl/speyk/inlevermoment/InleverMomentResourceTest_Bean
...
(
    ...
    ** label1
    ...
    INVOKEINTERFACE java/util/Set#add
    POP
    LDC (Type) Lnl/speyk/inlevermoment/InleverMomentResourceTest;
    LDC (String) "jwt"
    ...
    PUTFIELD nl/speyk/inlevermoment/InleverMomentResourceTest_Bean#injectProviderSupplier1
    ICONST_2
    ...
    PUTFIELD nl/speyk/inlevermoment/InleverMomentResourceTest_Bean#types
    RETURN
    ** label2
...
(
    ...
    ** label1
    LDC (String) "N3iRdEv5pFFDhpcTDb_1-2Y_ClA"
    ARETURN
    ** label2
...
// Access: private
Method doCreate : Lnl/speyk/inlevermoment/InleverMomentResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    NEW nl/speyk/inlevermoment/InleverMomentResourceTest
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/inlevermoment/InleverMomentResourceTest#<init>
    ASTORE 4
    ** label2
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD nl/speyk/inlevermoment/InleverMomentResourceTest_Bean#injectProviderSupplier1
    ...
    PUTFIELD nl/speyk/inlevermoment/InleverMomentResourceTest#jwt
    ** label3
    GOTO label4
    ** label5
    ASTORE 6
    ...
    DUP
    LDC (String) "Error injecting java.lang.String nl.speyk.inlevermoment.InleverMomentResourceTest.jwt"
    ALOAD 6
...
// Access: public
Method create : Lnl/speyk/inlevermoment/InleverMomentResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/inlevermoment/InleverMomentResourceTest;
    INVOKESPECIAL nl/speyk/inlevermoment/InleverMomentResourceTest_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/inlevermoment/InleverMomentResourceTest;
    INVOKEVIRTUAL nl/speyk/inlevermoment/InleverMomentResourceTest_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Lnl/speyk/inlevermoment/InleverMomentResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/inlevermoment/InleverMomentResourceTest;
    INVOKEVIRTUAL nl/speyk/inlevermoment/InleverMomentResourceTest_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD nl/speyk/inlevermoment/InleverMomentResourceTest_Bean#types
    ARETURN
    ** label2
