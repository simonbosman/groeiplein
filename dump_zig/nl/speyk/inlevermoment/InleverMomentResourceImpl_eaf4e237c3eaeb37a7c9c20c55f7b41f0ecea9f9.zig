// Class: nl/speyk/inlevermoment/InleverMomentResourceImpl_eaf4e237c3eaeb37a7c9c20c55f7b41f0ecea9f9
//     Access =  public synthetic
//     Extends: java/lang/Object
//     Implements:
//         nl/speyk/inlevermoment/InleverMomentResource
...
(
    ...
    ** label3
    ...
    INVOKESTATIC nl/speyk/inlevermoment/InleverMoment#findAll
    ASTORE 4
    ALOAD 4
    ALOAD 1
...
(
    ...
    ** label3
    ...
    INVOKESTATIC nl/speyk/inlevermoment/InleverMoment#find
    ASTORE 6
    ALOAD 6
    ALOAD 1
    // Method descriptor: (Lio/quarkus/panache/common/Page;)Lio/quarkus/hibernate/reactive/panache/PanacheQuery;
...
(
    ...
    ** label1
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKESTATIC nl/speyk/inlevermoment/InleverMoment#count
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    INVOKESTATIC nl/speyk/inlevermoment/InleverMoment#findById
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/inlevermoment/InleverMoment#persist
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL nl/speyk/inlevermoment/InleverMoment#$$_hibernate_write_id
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKESTATIC nl/speyk/inlevermoment/InleverMoment#getSession
    ASTORE 4
    ...
    ASTORE 3
    NEW nl/speyk/inlevermoment/InleverMomentResourceImpl_eaf4e237c3eaeb37a7c9c20c55f7b41f0ecea9f9$$function$$1
    DUP
    ALOAD 3
    ALOAD 2
    // Method descriptor: (Lorg/jboss/resteasy/reactive/server/core/ResteasyReactiveRequestContext;Ljava/lang/Object;)V
    INVOKESPECIAL nl/speyk/inlevermoment/InleverMomentResourceImpl_eaf4e237c3eaeb37a7c9c20c55f7b41f0ecea9f9$$function$$1#<init>
    ASTORE 5
    ALOAD 4
    ALOAD 5
    ...
    ASTORE 6
    NEW nl/speyk/inlevermoment/InleverMomentResourceImpl_eaf4e237c3eaeb37a7c9c20c55f7b41f0ecea9f9$$function$$2
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/inlevermoment/InleverMomentResourceImpl_eaf4e237c3eaeb37a7c9c20c55f7b41f0ecea9f9$$function$$2#<init>
    ASTORE 7
    ALOAD 6
...
(
    ...
    ** label1
    ALOAD 1
    // Method descriptor: (Ljava/lang/Object;)Lio/smallrye/mutiny/Uni;
    INVOKESTATIC nl/speyk/inlevermoment/InleverMoment#deleteById
    ARETURN
    ** label2
