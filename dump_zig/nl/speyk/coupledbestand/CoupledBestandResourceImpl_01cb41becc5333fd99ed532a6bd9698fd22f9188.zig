// Class: nl/speyk/coupledbestand/CoupledBestandResourceImpl_01cb41becc5333fd99ed532a6bd9698fd22f9188
//     Access =  public synthetic
//     Extends: java/lang/Object
//     Implements:
//         nl/speyk/coupledbestand/CoupledBestandResource
...
(
    ...
    ** label3
    ...
    INVOKESTATIC nl/speyk/coupledbestand/CoupledBestand#findAll
    ASTORE 4
    ALOAD 4
    ALOAD 1
...
(
    ...
    ** label3
    ...
    INVOKESTATIC nl/speyk/coupledbestand/CoupledBestand#find
    ASTORE 6
    ALOAD 6
    ALOAD 1
    // Method descriptor: (Lio/quarkus/panache/common/Page;)Lio/quarkus/hibernate/reactive/panache/PanacheQuery;
...
(
    ...
    ** label1
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKESTATIC nl/speyk/coupledbestand/CoupledBestand#count
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    INVOKESTATIC nl/speyk/coupledbestand/CoupledBestand#findById
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/coupledbestand/CoupledBestand#persist
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL nl/speyk/coupledbestand/CoupledBestand#$$_hibernate_write_id
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKESTATIC nl/speyk/coupledbestand/CoupledBestand#getSession
    ASTORE 4
    ...
    ASTORE 3
    NEW nl/speyk/coupledbestand/CoupledBestandResourceImpl_01cb41becc5333fd99ed532a6bd9698fd22f9188$$function$$1
    DUP
    ALOAD 3
    ALOAD 2
    // Method descriptor: (Lorg/jboss/resteasy/reactive/server/core/ResteasyReactiveRequestContext;Ljava/lang/Object;)V
    INVOKESPECIAL nl/speyk/coupledbestand/CoupledBestandResourceImpl_01cb41becc5333fd99ed532a6bd9698fd22f9188$$function$$1#<init>
    ASTORE 5
    ALOAD 4
    ALOAD 5
    ...
    ASTORE 6
    NEW nl/speyk/coupledbestand/CoupledBestandResourceImpl_01cb41becc5333fd99ed532a6bd9698fd22f9188$$function$$2
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/coupledbestand/CoupledBestandResourceImpl_01cb41becc5333fd99ed532a6bd9698fd22f9188$$function$$2#<init>
    ASTORE 7
    ALOAD 6
...
(
    ...
    ** label1
    ALOAD 1
    // Method descriptor: (Ljava/lang/Object;)Lio/smallrye/mutiny/Uni;
    INVOKESTATIC nl/speyk/coupledbestand/CoupledBestand#deleteById
    ARETURN
    ** label2
