// Class: nl/speyk/coupledbestand/CoupledBestandResourceTest_Bean
...
(
    ...
    ** label1
    ...
    INVOKEINTERFACE java/util/Set#add
    POP
    LDC (Type) Lnl/speyk/coupledbestand/CoupledBestandResourceTest;
    LDC (String) "jwt"
    ...
    PUTFIELD nl/speyk/coupledbestand/CoupledBestandResourceTest_Bean#injectProviderSupplier1
    ICONST_2
    ...
    PUTFIELD nl/speyk/coupledbestand/CoupledBestandResourceTest_Bean#types
    RETURN
    ** label2
...
(
    ...
    ** label1
    LDC (String) "GwCunm3cgiKF-hnZZOwOIj2PTcU"
    ARETURN
    ** label2
...
// Access: private
Method doCreate : Lnl/speyk/coupledbestand/CoupledBestandResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    NEW nl/speyk/coupledbestand/CoupledBestandResourceTest
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/coupledbestand/CoupledBestandResourceTest#<init>
    ASTORE 4
    ** label2
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD nl/speyk/coupledbestand/CoupledBestandResourceTest_Bean#injectProviderSupplier1
    ...
    PUTFIELD nl/speyk/coupledbestand/CoupledBestandResourceTest#jwt
    ** label3
    GOTO label4
    ** label5
    ASTORE 6
    ...
    DUP
    LDC (String) "Error injecting java.lang.String nl.speyk.coupledbestand.CoupledBestandResourceTest.jwt"
    ALOAD 6
...
// Access: public
Method create : Lnl/speyk/coupledbestand/CoupledBestandResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/coupledbestand/CoupledBestandResourceTest;
    INVOKESPECIAL nl/speyk/coupledbestand/CoupledBestandResourceTest_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/coupledbestand/CoupledBestandResourceTest;
    INVOKEVIRTUAL nl/speyk/coupledbestand/CoupledBestandResourceTest_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Lnl/speyk/coupledbestand/CoupledBestandResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/coupledbestand/CoupledBestandResourceTest;
    INVOKEVIRTUAL nl/speyk/coupledbestand/CoupledBestandResourceTest_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD nl/speyk/coupledbestand/CoupledBestandResourceTest_Bean#types
    ARETURN
    ** label2
