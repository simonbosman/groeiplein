...
(
    ...
    ** label1
    ...
    PUTFIELD nl/speyk/ApiMain_Bean#types
    RETURN
    ** label2
...
// Access: private
Method doCreate : Lnl/speyk/ApiMain;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    NEW nl/speyk/ApiMain
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/ApiMain#<init>
    ARETURN
    ** label2
...
// Access: public
Method create : Lnl/speyk/ApiMain;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/ApiMain;
    INVOKESPECIAL nl/speyk/ApiMain_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/ApiMain;
    INVOKEVIRTUAL nl/speyk/ApiMain_Bean#create
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/ApiMain;
    INVOKEVIRTUAL nl/speyk/ApiMain_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD nl/speyk/ApiMain_Bean#types
    ARETURN
    ** label2
