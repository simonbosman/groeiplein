// Class: nl/speyk/niveau/NiveauRepository_ClientProxy
...
(
    ...
    ** label1
    ...
    PUTFIELD nl/speyk/niveau/NiveauRepository_ClientProxy#bean
    ALOAD 2
    ...
    PUTFIELD nl/speyk/niveau/NiveauRepository_ClientProxy#context
    RETURN
    ** label2
...
// Access: private
Method arc$delegate : Lnl/speyk/niveau/NiveauRepository;
(
    // (no arguments)
) {
    ** label1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableBean;
    GETFIELD nl/speyk/niveau/NiveauRepository_ClientProxy#bean
    ASTORE 1
    ALOAD 0
    // Field descriptor: Lio/quarkus/arc/InjectableContext;
    GETFIELD nl/speyk/niveau/NiveauRepository_ClientProxy#context
    ALOAD 1
    ...
    CHECKCAST nl/speyk/niveau/NiveauRepository
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Method descriptor: ()Lnl/speyk/niveau/NiveauRepository;
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository_ClientProxy#arc$delegate
    ARETURN
    ** label2
...
(
    ...
    ** label5
    ...
    ALOAD 1
    // Method descriptor: (Ljava/lang/Object;)Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository#persistAndFlush
    ARETURN
    ** label6
...
(
    ...
    ** label5
    ...
    ALOAD 3
    // Method descriptor: (Ljava/lang/String;Lio/quarkus/panache/common/Sort;[Ljava/lang/Object;)Lio/quarkus/hibernate/reactive/panache/PanacheQuery;
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository#find
    ARETURN
    ** label6
...
(
    ...
    ** label5
    ...
    ALOAD 2
    // Method descriptor: (Ljava/lang/String;Lio/quarkus/panache/common/Parameters;)Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository#update
    ARETURN
    ** label6
...
(
    ...
    ** label5
    ...
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository_ClientProxy#arc$delegate
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository#deleteAll
    ARETURN
    ** label6
...
(
    ...
    ** label5
    ...
    ALOAD 2
    // Method descriptor: (Ljava/lang/String;Lio/quarkus/panache/common/Parameters;)Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository#count
    ARETURN
    ** label6
...
(
    ...
    ** label5
    ...
    ALOAD 3
    // Method descriptor: (Ljava/lang/String;Lio/quarkus/panache/common/Sort;Ljava/util/Map;)Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository#list
    ARETURN
    ** label6
...
(
    ...
    ** label2
    ...
    INVOKESPECIAL nl/speyk/niveau/NiveauRepository#toString
    ARETURN
    ** label5
    ALOAD 0
    // Method descriptor: ()Lnl/speyk/niveau/NiveauRepository;
...
(
    ...
    ** label5
    ...
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository_ClientProxy#arc$delegate
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository#getSession
    ARETURN
    ** label6
...
(
    ...
    ** label5
    ...
    ALOAD 1
    // Method descriptor: (Ljava/lang/Object;)Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository#delete
    ARETURN
    ** label6
...
(
    ...
    ** label5
    ...
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository_ClientProxy#arc$delegate
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository#listAll
    ARETURN
    ** label6
...
(
    ...
    ** label5
    ...
    ALOAD 2
    // Method descriptor: (Ljava/lang/Object;Ljakarta/persistence/LockModeType;)Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository#findById
    ARETURN
    ** label6
...
(
    ...
    ** label5
    ...
    ALOAD 1
    // Method descriptor: (Ljava/lang/Object;)Z
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository#isPersistent
    IRETURN
    ** label6
...
(
    ...
    ** label5
    ...
    ALOAD 2
    // Method descriptor: (Ljava/lang/Object;[Ljava/lang/Object;)Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository#persist
    ARETURN
    ** label6
...
(
    ...
    ** label5
    ...
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository_ClientProxy#arc$delegate
    // Method descriptor: ()Lio/quarkus/hibernate/reactive/panache/PanacheQuery;
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository#findAll
    ARETURN
    ** label6
...
(
    ...
    ** label5
    ...
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository_ClientProxy#arc$delegate
    // Method descriptor: ()Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository#flush
    ARETURN
    ** label6
...
(
    ...
    ** label5
    ...
    ALOAD 1
    // Method descriptor: (Ljava/lang/Object;)Lio/smallrye/mutiny/Uni;
    INVOKEVIRTUAL nl/speyk/niveau/NiveauRepository#deleteById
    ARETURN
    ** label6
