// Class: nl/speyk/niveau/NiveauResourceTest_Bean
...
(
    ...
    ** label1
    ...
    INVOKEINTERFACE java/util/Set#add
    POP
    LDC (Type) Lnl/speyk/niveau/NiveauResourceTest;
    LDC (String) "jwt"
    ...
    PUTFIELD nl/speyk/niveau/NiveauResourceTest_Bean#injectProviderSupplier1
    ICONST_2
    ...
    PUTFIELD nl/speyk/niveau/NiveauResourceTest_Bean#types
    RETURN
    ** label2
...
(
    ...
    ** label1
    LDC (String) "jUNstTgtWGwXVd-VvZa440CvQW0"
    ARETURN
    ** label2
...
// Access: private
Method doCreate : Lnl/speyk/niveau/NiveauResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    NEW nl/speyk/niveau/NiveauResourceTest
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/niveau/NiveauResourceTest#<init>
    ASTORE 4
    ** label2
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD nl/speyk/niveau/NiveauResourceTest_Bean#injectProviderSupplier1
    ...
    PUTFIELD nl/speyk/niveau/NiveauResourceTest#jwt
    ** label3
    GOTO label4
    ** label5
    ASTORE 6
    ...
    DUP
    LDC (String) "Error injecting java.lang.String nl.speyk.niveau.NiveauResourceTest.jwt"
    ALOAD 6
...
// Access: public
Method create : Lnl/speyk/niveau/NiveauResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/niveau/NiveauResourceTest;
    INVOKESPECIAL nl/speyk/niveau/NiveauResourceTest_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/niveau/NiveauResourceTest;
    INVOKEVIRTUAL nl/speyk/niveau/NiveauResourceTest_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Lnl/speyk/niveau/NiveauResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/niveau/NiveauResourceTest;
    INVOKEVIRTUAL nl/speyk/niveau/NiveauResourceTest_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD nl/speyk/niveau/NiveauResourceTest_Bean#types
    ARETURN
    ** label2
