// Class: nl/speyk/vakleergebied/VakleergebiedResourceTest_Bean
...
(
    ...
    ** label1
    ...
    INVOKEINTERFACE java/util/Set#add
    POP
    LDC (Type) Lnl/speyk/vakleergebied/VakleergebiedResourceTest;
    LDC (String) "jwt"
    ...
    PUTFIELD nl/speyk/vakleergebied/VakleergebiedResourceTest_Bean#injectProviderSupplier1
    ICONST_2
    ...
    PUTFIELD nl/speyk/vakleergebied/VakleergebiedResourceTest_Bean#types
    RETURN
    ** label2
...
(
    ...
    ** label1
    LDC (String) "4nXytzmZYqWw_QnvMVfrVeGK76U"
    ARETURN
    ** label2
...
// Access: private
Method doCreate : Lnl/speyk/vakleergebied/VakleergebiedResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    NEW nl/speyk/vakleergebied/VakleergebiedResourceTest
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/vakleergebied/VakleergebiedResourceTest#<init>
    ASTORE 4
    ** label2
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD nl/speyk/vakleergebied/VakleergebiedResourceTest_Bean#injectProviderSupplier1
    ...
    PUTFIELD nl/speyk/vakleergebied/VakleergebiedResourceTest#jwt
    ** label3
    GOTO label4
    ** label5
    ASTORE 6
    ...
    DUP
    LDC (String) "Error injecting java.lang.String nl.speyk.vakleergebied.VakleergebiedResourceTest.jwt"
    ALOAD 6
...
// Access: public
Method create : Lnl/speyk/vakleergebied/VakleergebiedResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/vakleergebied/VakleergebiedResourceTest;
    INVOKESPECIAL nl/speyk/vakleergebied/VakleergebiedResourceTest_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/vakleergebied/VakleergebiedResourceTest;
    INVOKEVIRTUAL nl/speyk/vakleergebied/VakleergebiedResourceTest_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Lnl/speyk/vakleergebied/VakleergebiedResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/vakleergebied/VakleergebiedResourceTest;
    INVOKEVIRTUAL nl/speyk/vakleergebied/VakleergebiedResourceTest_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD nl/speyk/vakleergebied/VakleergebiedResourceTest_Bean#types
    ARETURN
    ** label2
