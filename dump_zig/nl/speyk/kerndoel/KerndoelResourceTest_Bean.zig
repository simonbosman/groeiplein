// Class: nl/speyk/kerndoel/KerndoelResourceTest_Bean
...
(
    ...
    ** label1
    ...
    INVOKEINTERFACE java/util/Set#add
    POP
    LDC (Type) Lnl/speyk/kerndoel/KerndoelResourceTest;
    LDC (String) "jwt"
    ...
    PUTFIELD nl/speyk/kerndoel/KerndoelResourceTest_Bean#injectProviderSupplier1
    ICONST_2
    ...
    PUTFIELD nl/speyk/kerndoel/KerndoelResourceTest_Bean#types
    RETURN
    ** label2
...
(
    ...
    ** label1
    LDC (String) "KX5_bQkg6QtTTDM-kskf9SI-W9s"
    ARETURN
    ** label2
...
// Access: private
Method doCreate : Lnl/speyk/kerndoel/KerndoelResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    NEW nl/speyk/kerndoel/KerndoelResourceTest
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL nl/speyk/kerndoel/KerndoelResourceTest#<init>
    ASTORE 4
    ** label2
    ALOAD 0
    // Field descriptor: Ljava/util/function/Supplier;
    GETFIELD nl/speyk/kerndoel/KerndoelResourceTest_Bean#injectProviderSupplier1
    ...
    PUTFIELD nl/speyk/kerndoel/KerndoelResourceTest#jwt
    ** label3
    GOTO label4
    ** label5
    ASTORE 6
    ...
    DUP
    LDC (String) "Error injecting java.lang.String nl.speyk.kerndoel.KerndoelResourceTest.jwt"
    ALOAD 6
...
// Access: public
Method create : Lnl/speyk/kerndoel/KerndoelResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
    ** label2
    ALOAD 0
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/kerndoel/KerndoelResourceTest;
    INVOKESPECIAL nl/speyk/kerndoel/KerndoelResourceTest_Bean#doCreate
    ARETURN
    ** label3
    GOTO label4
    ** label5
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/kerndoel/KerndoelResourceTest;
    INVOKEVIRTUAL nl/speyk/kerndoel/KerndoelResourceTest_Bean#create
    ARETURN
    ** label2
...
// Access: public
Method get : Lnl/speyk/kerndoel/KerndoelResourceTest;
(
    arg 1 = Ljakarta/enterprise/context/spi/CreationalContext;
) {
    ** label1
...
(
    ...
    ** label1
    ...
    ALOAD 1
    // Method descriptor: (Ljakarta/enterprise/context/spi/CreationalContext;)Lnl/speyk/kerndoel/KerndoelResourceTest;
    INVOKEVIRTUAL nl/speyk/kerndoel/KerndoelResourceTest_Bean#get
    ARETURN
    ** label2
...
(
    ...
    ** label1
    ALOAD 0
    // Field descriptor: Ljava/util/Set;
    GETFIELD nl/speyk/kerndoel/KerndoelResourceTest_Bean#types
    ARETURN
    ** label2
